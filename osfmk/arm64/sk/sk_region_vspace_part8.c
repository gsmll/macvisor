...
extern void sk_fatal_error(unsigned long, ...)
...
extern unsigned long sk_set_hash(void);                             /* thunk_FUN_00229ebc */
extern void sk_set_dup_panic(unsigned long msg);                    /* FUN_0025bddc */
extern long sk_set_descriptor(void *);                              /* FUN_0025a060 */
extern unsigned long sk_buf_copy(unsigned long, unsigned long, unsigned long, ...); /* FUN_001f7be0 */
extern unsigned long sk_buf_copy2(unsigned long, unsigned long, unsigned long, ...); /* FUN_001f0700 */
extern unsigned long sk_buf_range(unsigned long, unsigned long, unsigned long);    /* FUN_001f7d28 */
extern unsigned long sk_buf_range2(unsigned long, unsigned long);                  /* FUN_001f0bb4 */
extern void sk_elem_map(unsigned long, unsigned long, unsigned long, unsigned long); /* FUN_0019ce60 */
extern unsigned long sk_slot_key(unsigned long, unsigned long, unsigned long, ...); /* FUN_0031b524 */
extern unsigned long sk_slot_grow(unsigned long, unsigned long, unsigned long, ...); /* FUN_001faaf0 */
extern unsigned long sk_hash_slot(unsigned long, unsigned long, ...); /* FUN_001ee140 */
extern void sk_set_apply_cb(unsigned long, unsigned long, ...);     /* FUN_001f99f4 */
extern unsigned long sk_set_slot_next(unsigned long, ...);          /* FUN_00310d68 */
extern unsigned long sk_set_buf_pack(unsigned long, unsigned long, ...); /* FUN_001fca54 */
...
extern unsigned long sk_vspace_word(unsigned long, unsigned long, ...);  /* FUN_001e6e60 */
extern unsigned long sk_vspace_word2(unsigned long, unsigned long, ...); /* FUN_001e63c4 */
extern unsigned long sk_vspace_word3(unsigned long, unsigned long, ...); /* FUN_001e74ac */
extern unsigned long sk_vspace_word4(unsigned long, unsigned long, ...); /* FUN_001e6edc */
extern unsigned long sk_vspace_word5(unsigned long, unsigned long, ...); /* FUN_001e6444 */
extern unsigned long sk_vspace_word6(unsigned long, unsigned long, ...); /* FUN_001e7520 */
extern unsigned long sk_vspace_word7(unsigned long, unsigned long, ...); /* FUN_001e3324 */
extern void *sk_vspace_pair(unsigned long, ...);                    /* FUN_0019fa14 */
extern void *sk_vspace_pair2(unsigned long, ...);                   /* FUN_0019fa28 */
extern void *sk_vspace_pair3(unsigned long, unsigned long, unsigned long); /* FUN_001a0870 */
extern void sk_vspace_noop(unsigned long, ...);                     /* FUN_001a008c */
extern unsigned long sk_vspace_ctx(void);                           /* FUN_00254fa4 */
extern unsigned long sk_vspace_ctx2(unsigned long, unsigned long, ...); /* FUN_00254fb4 */
extern void *sk_vspace_cb_sel(void);                                /* FUN_0001a1c8 */
extern unsigned long sk_vspace_lz(unsigned long, ...);                            /* FUN_0034b384 */
extern unsigned long sk_vspace_sw(void);                            /* FUN_003592a0 */
extern unsigned long sk_vspace_name_hash(unsigned long, ...);       /* FUN_002a200c */
extern void sk_vspace_name_store(unsigned long, void *, ...);       /* FUN_00356164 */
extern void sk_vspace_name_fin(void);                               /* thunk_FUN_002a2698 */
extern void sk_vspace_fail(unsigned long, ...);                     /* FUN_003488bc */
extern unsigned long sk_vspace_lookup(unsigned long, unsigned long);    /* FUN_0026bd30 */
extern void sk_vspace_push(unsigned long, unsigned long, unsigned long); /* FUN_001d2d1c */

/* Opaque per-op helpers invoked by the vspace dispatch wrappers
 * (FUN_001a5xxx family) and the dense service loops. */
extern void sk_op_1a5f6c(void);   /* FUN_001a5f6c */
extern void sk_op_1a5ee0(void);   /* FUN_001a5ee0 */
extern void sk_op_1a5e5c(void);   /* FUN_001a5e5c */
extern void sk_op_1a5dd4(void);   /* FUN_001a5dd4 */
extern void sk_op_1a5d34(void);   /* FUN_001a5d34 */
extern void sk_op_1a5c14(void);   /* FUN_001a5c14 */
extern void sk_op_1a6124(void);   /* FUN_001a6124 */
extern void sk_op_1a6244(void);   /* FUN_001a6244 */
extern void sk_op_1a6364(void);   /* FUN_001a6364 */
extern void sk_op_1a6484(void);   /* FUN_001a6484 */
extern void sk_op_1a6690(void);   /* FUN_001a6690 */
extern void sk_vspace_dispatch2(unsigned long, unsigned long, void *); /* FUN_0025611c */

/* ------------------------------------------------------------------ *
 * In-slice forward declarations.
 * ------------------------------------------------------------------ */
static word_t sk_vspace_slot_path(word_t *buf, uint32_t index);
static void sk_vspace_op_wrap_copy(word_t *dst, const word_t *src);
extern unsigned long sk_vspace_completion(void);                     /* FUN_002a218c */
extern unsigned char DAT_00657798[];                                 /* &DAT_00657798 sentinel */
extern unsigned char sk_swift_unknown_5ce2a[];                       /* s_key_value_005cea2a */
extern unsigned char sk_swift_unknown_5cdc10[];                      /* s_Swift_UnsafeBufferPointer_swift_005cdc10 */

/* In-slice cross-referenced forward declarations (defined below). */
void FUN_00256f34(void);
void FUN_00257020(void);
void FUN_00259954(word_t a, word_t b, word_t c, long set, word_t e);
void FUN_0025a094(void);
void FUN_0025af6c(void);
uint8_t FUN_002557b8(uint32_t index, long pos);
...
/* FUN_00255100 @ 0x00255100   (est. sk_vspace_retag_word)
 * Ghidra: void FUN_00255100(undefined8 *param_1)
 * Reads the 64-bit capability word at *param_1, applies the vspace helper
 * FUN_001e6e60 (word transform keyed by the context in x20) and stores the
 ...
 */
void FUN_00255100(uint64_t *slot)
{
    *slot = sk_vspace_word(*slot, 0);   /* FUN_001e6e60(*slot, *x20) */
}
...
{
    word_t lo = (word_t)sk_object_lock(0, 0, 0, 0, 0);   /* FUN_00351124() lo */
    word_t hi = (word_t)sk_cpu();                        /* FUN_00351124() hi (est.) */
    word_t r = sk_vspace_word2(lo, hi, 0);               /* FUN_001e63c4(lo,hi,*x20) */
    (void)r;   /* stored into the x19 output slot (register-inherited) */
}

/* FUN_0025515c @ 0x0025515c   (est. sk_vspace_pipeline_a)
 * Ghidra: void FUN_0025515c(void)
 ...
 */
void FUN_0025515c(void)
{
    /* FUN_0034c434(); FUN_001e32a8(); FUN_0035272c(); */
    sk_object_lock(0, 0, 0, 0, 0);   /* representative call; pipeline in comment */
}

/* FUN_00255198 @ 0x00255198   (est. sk_vspace_ctx_load)
 * Ghidra: void FUN_00255198(undefined8 *param_1)
 * Reads the vspace context word via FUN_00254fa4(*x20) and stores it into
 * *param_1.
 * Confidence: medium
 */
void FUN_00255198(uint64_t *out)
{
    *out = sk_vspace_ctx();         /* FUN_00254fa4(*x20) */
}
...
{
    *sel_out = (uint16_t)sk_vspace_ctx2(*param_2, 0);   /* FUN_00254fb4(*param_2,*x20) */
    /* returns {FUN_0001a1c8, sel_out} 16-byte closure record */
    return (void *)sel_out;
}

/* FUN_00255228 @ 0x00255228   (est. sk_vspace_pair_record)
 * Ghidra: void FUN_00255228(undefined1 (*param_1) [16])
 * Fills the 16-byte buffer *param_1 from FUN_0019fa14(*x20).
 * Confidence: medium
 */
void FUN_00255228(unsigned char (*out)[16])
{
    uint64_t v = (uint64_t)sk_vspace_pair(0);   /* FUN_0019fa14(*x20) */
    memcpy(out, &v, 16);
}

/* FUN_0025525c @ 0x0025525c   (est. sk_vspace_word_in)
 * Ghidra: void FUN_0025525c(undefined8 *param_1, undefined8 *param_2)
 * Applies FUN_001e74ac(*param_2,*x20) and stores the word into *param_1.
 * Confidence: medium
 */
void FUN_0025525c(uint64_t *out, uint64_t *src)
{
    *out = sk_vspace_word3(*src, 0);   /* FUN_001e74ac(*param_2,*x20) */
}

/* FUN_0025528c @ 0x0025528c   (est. sk_vspace_word_self)
 * Ghidra: void FUN_0025528c(undefined8 *param_1)
 * Applies FUN_001e74ac(*param_1,*x20) in place on the word at *param_1.
 * Confidence: medium
 */
void FUN_0025528c(uint64_t *slot)
{
    *slot = sk_vspace_word3(*slot, 0);   /* FUN_001e74ac(*param_1,*x20) */
}

/* FUN_002552d4 @ 0x002552d4   (est. sk_vspace_level_of)
 * Ghidra: undefined8 FUN_002552d4(uint param_1)
 ...
 */
unsigned long FUN_002552d4(uint32_t index)
{
...
/* FUN_002552fc @ 0x002552fc   (est. sk_vspace_level_of2)
 * Ghidra: undefined8 FUN_002552fc(uint param_1)
 * Identical level classifier to FUN_002552d4 (same thresholds), differing only
 * in decompiler variable naming. Returns 1/2/3/4.
 * Confidence: high
 */
unsigned long FUN_002552fc(uint32_t index)
{
    if (index < 0x80) return 1;
    if (index < 0x800) return 2;
    if (index < 0x10000) return 3;
...
/* FUN_00255324 @ 0x00255324   (est. sk_vspace_path_assert)
 * Ghidra: void FUN_00255324(ulong param_1, undefined8 param_2)
 ...
 * level, reads the path byte via FUN_002557b8; otherwise raises a fatal error
 * (FUN_003488bc(1); FUN_0034a6b0(); noreturn FUN_001afe4c).
 * Confidence: medium
 * Notes: noreturn panic on out-of-range level.
 */
void FUN_00255324(uint64_t offset, uint64_t index)
{
    unsigned long level = FUN_002552d4((uint32_t)index);
    if ((int64_t)offset >= 0 && offset < level) {
        FUN_002557b8((uint32_t)index, (long)offset);
        return;
    }
    sk_vspace_fail(1);          /* FUN_003488bc(1) */
    sk_fatal_error(0);          /* FUN_001afe4c noreturn */
}

/* FUN_002553b4 @ 0x002553b4   (est. sk_vspace_hash_compress)
 * Ghidra: void FUN_002553b4(uint param_1, ulong *param_2)
 ...
 */
void FUN_002553b4(uint32_t index, uint64_t *state)
{
    word_t path[16];
...
/* FUN_002554f4 @ 0x002554f4   (est. sk_vspace_hash_update_str)
 * Ghidra: void FUN_002554f4(uint param_1, long *param_2)
 ...
 * Confidence: medium
 */
void FUN_002554f4(uint32_t index, long *buf)
{
    word_t path[16];
    word_t len = sk_vspace_slot_path(path, index);
    uint8_t *bytes = (uint8_t *)path;
    for (word_t i = 0; i < len; i++) {
        uint8_t c = bytes[i];
        long *b = buf;
        if ((sk_swift_string_hash() & 1) == 0) {      /* FUN_003a261c(b) */
            b = sk_vspace_pair3(0, *(long *)(b + 0x10) + 1, 1);  /* FUN_001a0870 */
            *buf = (long)b;
        }
        uint64_t n = *(uint64_t *)(b + 0x10);
        if (*(uint64_t *)(b + 0x18) >> 1 <= n) {
            b = sk_vspace_pair3(*(uint64_t *)(b + 0x18) > 1, n + 1, 1);  /* FUN_001a0870 */
            *buf = (long)b;
        }
        *(uint64_t *)(b + 0x10) = n + 1;
...
/* FUN_0025564c @ 0x0025564c   (est. sk_vspace_slot_path_iter)
 * Ghidra: void FUN_0025564c(uint param_1, code *param_2)
 * Iterates the slot path bytes of index param_1, invoking the callback
 * param_2 once per byte. Stops after `len` bytes.
 * Confidence: medium
 */
void FUN_0025564c(uint32_t index, void (*cb)(uint8_t))
{
    word_t path[16];
    word_t len = sk_vspace_slot_path(path, index);
    uint8_t *bytes = (uint8_t *)path;
...
/* FUN_00255738 @ 0x00255738   (est. sk_vspace_path_lookup)
 * Ghidra: void FUN_00255738(uint param_1)
 ...
 * Confidence: medium
 * Notes: level arithmetic includes FUN_003592a0 / FUN_0034b384 branches.
 */
void FUN_00255738(uint32_t index)
{
    word_t path[16];
    int encoded;
    if (index < 0x80) {
        ...
        sk_vspace_sw();               /* FUN_003592a0() */
        encoded = index + 1;          /* extraout_w8 + extraout_w10 (est.) */
    } else {
        sk_vspace_lz((index & 0x3f) << 8);   /* FUN_0034b384() */
        encoded = (index & 0x3f) + 0x80;     /* extraout_w11 (est.) */
    }
    word_t len = sk_vspace_slot_path(path, encoded);
    unsigned long h = sk_vspace_name_hash((unsigned long)path);   /* FUN_002a200c */
    sk_vspace_name_store(h, path);                                /* FUN_00356164 */
    sk_vspace_name_fin();                                         /* thunk_FUN_002a2698 */
    (void)len;
}

/* FUN_002557b8 @ 0x002557b8   (est. sk_vspace_slot_path_byte)
 * Ghidra: undefined1 FUN_002557b8(uint param_1, long param_2)
 ...
 * Notes: fatal via FUN_001afe4c with s_Swift_UnsafeBufferPointer string.
 */
uint8_t FUN_002557b8(uint32_t index, long pos)
{
    word_t path[16];
    word_t len = sk_vspace_slot_path(path, index);
    if (pos < 0) {
        sk_fatal_error(0x75d);   /* Swift/UnsafeBufferPointer bounds panic */
    }
    if (pos < (long)len) {
        return ((uint8_t *)path)[pos];
    }
    sk_fatal_error(0x75e);
    return 0;   /* unreachable (noreturn) */
}

/* FUN_002558d0 @ 0x002558d0   (est. sk_vspace_path_dispatch)
 * Ghidra: void FUN_002558d0(undefined8 param_1, undefined8 param_2,
 *                          uint param_3, undefined8 param_4)
 * Builds the slot path for index param_3 and dispatches a vspace operation
 * through the global jump slot DAT_00658c00, passing the 16-byte path and
 * several method/context records (FUN_002514f0 dispatch). Pipeline-heavy.
 * Confidence: low (dense dispatch pipeline, indirect calls)
 */
void FUN_002558d0(word_t a, word_t b, uint32_t index, word_t param_4)
{
    (void)a; (void)b; (void)param_4;
    /* FUN_00358fb4(); FUN_00351a68(); level arithmetic for index; then
     * (*DAT_00658c00)(); FUN_0034a210(); FUN_00002534();
     * FUN_002514f0(&path, FUN_0031d284, ...) — dispatch pipeline. */
    (*(void (**)(void))(0x658c00))();   /* DAT_00658c00 global jump slot */
}

/* FUN_00255a28 @ 0x00255a28   (est. sk_vspace_word4_in)
 * Ghidra: void FUN_00255a28(undefined8 *param_1, undefined8 *param_2)
 * Applies FUN_001e6edc(*param_2,*x20) and stores into *param_1.
 * Confidence: medium
 */
void FUN_00255a28(uint64_t *out, uint64_t *src)
{
    *out = sk_vspace_word4(*src, 0);   /* FUN_001e6edc(*param_2,*x20) */
}

/* FUN_00255a58 @ 0x00255a58   (est. sk_vspace_dec_ref)
 * Ghidra: void FUN_00255a58(long *param_1)
 ...
 * and releases the old count via FUN_0026bd30/FUN_001d2d1c.
 * Confidence: medium
 * Notes: refcount underflow -> brk trap.
 */
void FUN_00255a58(long *ref)
{
    long old = *ref;
    if (!__builtin_sub_overflow(old, 1, ref)) {
        unsigned long level = FUN_002552fc(0);
        sk_vspace_lookup(0, level);              /* FUN_0026bd30(0, level) */
        sk_vspace_push(old - 1, 0, 0);           /* FUN_001d2d1c(...) */
        return;
    }
    __builtin_trap();   /* SoftwareBreakpoint(1, 0x255ac0) */
}

/* FUN_00255ac0 @ 0x00255ac0   (est. sk_vspace_word5_transform)
 * Ghidra: void FUN_00255ac0(void)
 ...
 * Confidence: medium
 */
void FUN_00255ac0(void)
{
    word_t lo = (word_t)sk_object_lock(0, 0, 0, 0, 0);  /* FUN_00351124() lo */
    word_t hi = (word_t)sk_cpu();                       /* FUN_00351124() hi (est.) */
    word_t r = sk_vspace_word5(lo, hi, 0);              /* FUN_001e6444(lo,hi,*x20) */
    (void)r;   /* stored into the x19 output slot (register-inherited) */
}

/* FUN_00255aec @ 0x00255aec   (est. sk_vspace_pipeline_b)
 * Ghidra: void FUN_00255aec(void)
 * Three-step helper pipeline (FUN_0034c434; FUN_001e3324; FUN_0035272c).
 * Confidence: low (opaque helper sequence)
 */
void FUN_00255aec(void)
{
    /* FUN_0034c434(); FUN_001e3324(); FUN_0035272c(); */
    sk_object_lock(0, 0, 0, 0, 0);   /* representative call; pipeline in comment */
}

/* FUN_00255b28 @ 0x00255b28   (est. sk_vspace_level_get)
 * Ghidra: void FUN_00255b28(undefined8 *param_1)
 * Stores FUN_002552d4(*x20) (the slot-index level) into *param_1.
 * Confidence: medium
 */
void FUN_00255b28(uint64_t *out)
{
    *out = FUN_002552d4(0);   /* FUN_002552d4(*x20) */
}
 ...
 * Computes a byte from FUN_00255324(*param_2,*x20), stores it into *param_1,
...
{
    /* FUN_00255324(*param_2,*x20) computes the path byte */ FUN_00255324(0, 0);   /* FUN_00255324(*param_2,*x20) */
    /* returns {FUN_0001a1c8, out} 16-byte closure record */
    return (void *)out;
}

/* FUN_00255bb8 @ 0x00255bb8   (est. sk_vspace_dispatch)
 * Ghidra: void FUN_00255bb8(void)
...
/* FUN_00255bf0 @ 0x00255bf0   (est. sk_vspace_pair_record2)
 * Ghidra: void FUN_00255bf0(undefined1 (*param_1) [16])
 * Fills the 16-byte buffer *param_1 from FUN_0019fa28(*x20).
 * Confidence: medium
 */
void FUN_00255bf0(unsigned char (*out)[16])
{
    uint64_t v = (uint64_t)sk_vspace_pair2(0);   /* FUN_0019fa28(*x20) */
    memcpy(out, &v, 16);
}

/* FUN_00255c28 @ 0x00255c28   (est. sk_vspace_word6_in)
 * Ghidra: void FUN_00255c28(undefined8 *param_1, undefined8 *param_2)
 * Applies FUN_001e7520(*param_2,*x20) and stores into *param_1.
 * Confidence: medium
 */
void FUN_00255c28(uint64_t *out, uint64_t *src)
{
    *out = sk_vspace_word6(*src, 0);   /* FUN_001e7520(*param_2,*x20) */
}
 ...
 * via FUN_0026bd30/FUN_001d2d1c first.
 * Confidence: medium
...
void FUN_00255c58(long *ref)
{
    ...
    unsigned long level = FUN_002552fc(0);
    sk_vspace_lookup(0, level);              /* FUN_0026bd30(0, level) */
    sk_vspace_push(old, 0, 0);               /* FUN_001d2d1c(old,...) */
...
/* FUN_00255cc4 @ 0x00255cc4   (est. sk_vspace_noop_a)
 * Ghidra: void FUN_00255cc4(void)
 * Calls FUN_001a008c(*x20) — a context-keyed no-op/commit.
 * Confidence: low
 */
void FUN_00255cc4(void)
{
    sk_vspace_noop(0);   /* FUN_001a008c(*x20) */
}

/* FUN_00255cc8 @ 0x00255cc8   (est. sk_vspace_noop_b)
 * Ghidra: void FUN_00255cc8(void)
 * Identical to FUN_00255cc4: FUN_001a008c(*x20).
 * Confidence: low
 */
...
/* FUN_00255d00 @ 0x00255d00   (est. sk_vspace_read_word)
 * Ghidra: undefined4 FUN_00255d00(void)
 ...
 */
uint32_t FUN_00255d00(void)
{
    return 0;   /* in_w8 — register-inherited, no store */
}

/* FUN_00255d30 @ 0x00255d30   (est. sk_vspace_select)
 * Ghidra: void FUN_00255d30(void)
 * Selects between two register-returned values (FUN_0034b384 + extraout_w11
 * vs extraout_w8) based on the ZR flag, then tails into FUN_00255d00.
 * Confidence: low (flag-dependent selector shim)
 */
void FUN_00255d30(void)
{
    /* FUN_0034b384(); uVar1 = (ZR) ? extraout_w8 : extraout_w11;
     * FUN_00255d00(uVar1); */
    sk_vspace_lz(0);   /* FUN_0034b384() */
}
...
static word_t sk_vspace_slot_path(word_t *buf, uint32_t index)
{
    ...
    len = FUN_002552d4(index);
    return len;
}

/* FUN_00255d88 @ 0x00255d88   (est. sk_vspace_path_record)
 * Ghidra: void FUN_00255d88(undefined8 param_1, undefined8 param_2,
 ...
 */
void FUN_00255d88(word_t p1, word_t p2, word_t p3, word_t p4, word_t p5,
                  word_t p6, word_t *out)
{
    (void)p1; (void)p2; (void)p3; (void)p4; (void)p5; (void)p6;
    /* FUN_00002534(&DAT_0064c260,&DAT_004bbc30);
...
/* FUN_00255e68 @ 0x00255e68   (est. sk_vspace_buf_check)
 * Ghidra: void FUN_00255e68(undefined8 param_1, code *param_2, undefined8,
 ...
 */
void FUN_00255e68(word_t a, void (*cb)(void), word_t c, long *idx,
                  word_t e, long *out)
{
    ...
    sk_fatal_error(0x582);   /* UnsafeBufferPointer negative-index panic */
}

/* FUN_00255efc @ 0x00255efc   (est. sk_vspace_op_a)
 * Ghidra: void FUN_00255efc(void)
 * Base op A: FUN_00356bec(); FUN_00353498(9); FUN_001a6124(); FUN_0034a224().
 * Confidence: low (opaque helper pipeline)
 */
void FUN_00255efc(word_t *out, word_t ctx)
{
    (void)out; (void)ctx;
    /* FUN_00356bec(); FUN_00353498(9); FUN_001a6124(); FUN_0034a224(); */
    sk_op_1a6124();
}

/* FUN_00255f34 @ 0x00255f34   (est. sk_vspace_op_a_wrap)
 * Ghidra: void FUN_00255f34(undefined8 *param_1)
 * Wrapper: runs op A into a local and copies the 0x29-byte result out.
 * Confidence: low
 */
void FUN_00255f34(word_t *out)
{
    word_t local[6];
    FUN_00255efc(local, 0);          /* FUN_00255efc(&local_50, *x20) */
    sk_vspace_op_wrap_copy(out, local);
}

/* FUN_00255f8c @ 0x00255f8c   (est. sk_vspace_op_b)
 * Ghidra: void FUN_00255f8c(void)
 * Base op B: FUN_00356bec(); FUN_00353498(9); FUN_001a6244(); FUN_0034a224().
 * Confidence: low
 */
void FUN_00255f8c(word_t *out, word_t ctx)
{
    (void)out; (void)ctx;
    /* FUN_00356bec(); FUN_00353498(9); FUN_001a6244(); FUN_0034a224(); */
    sk_op_1a6244();
}

/* FUN_00255fc4 @ 0x00255fc4   (est. sk_vspace_op_b_wrap)
 * Ghidra: void FUN_00255fc4(undefined8 *param_1)
 * Wrapper for op B.
 * Confidence: low
 */
void FUN_00255fc4(word_t *out)
{
    word_t local[6];
 ...
 * Base op C: FUN_0034b23c(); FUN_001a6364(); FUN_0034a224().
 * Confidence: low
 */
void FUN_0025601c(word_t *out, word_t ctx)
{
    (void)out; (void)ctx;
    /* FUN_0034b23c(); FUN_001a6364(); FUN_0034a224(); */
    sk_op_1a6364();
}

/* FUN_00256050 @ 0x00256050   (est. sk_vspace_op_c_wrap)
 * Ghidra: void FUN_00256050(undefined8 *param_1)
 * Wrapper for op C.
 * Confidence: low
 */
void FUN_00256050(word_t *out)
{
    word_t local[6];
...
/* FUN_002560a8 @ 0x002560a8   (est. sk_vspace_op_d)
 * Ghidra: void FUN_002560a8(undefined8 param_1, undefined8 param_2)
 * Base op D: FUN_0025611c(param_1, param_2, FUN_001a6484).
 * Confidence: low
 */
void FUN_002560a8(word_t a, word_t b)
{
    sk_vspace_dispatch2(a, b, sk_op_1a6484);   /* FUN_0025611c(...,FUN_001a6484) */
}
...
{
    word_t local[6];
    sk_vspace_dispatch2((word_t)local, 0, sk_op_1a6484);  /* FUN_002560a8(...) */
    sk_vspace_op_wrap_copy(out, local);
}

/* FUN_00256104 @ 0x00256104   (est. sk_vspace_op_e)
 * Ghidra: void FUN_00256104(undefined8 param_1, undefined8 param_2)
 * Base op E: FUN_0025611c(param_1, param_2, FUN_001a6690).
 * Confidence: low
 */
void FUN_00256104(word_t a, word_t b)
{
    sk_vspace_dispatch2(a, b, sk_op_1a6690);   /* FUN_0025611c(...,FUN_001a6690) */
}

/* FUN_0025611c @ 0x0025611c   (est. sk_vspace_op_dispatch)
 * Ghidra: void FUN_0025611c(void)
 ...
 */
void FUN_0025611c(word_t a, word_t b, void (*cb)(void))
{
    (void)a; (void)b;
...
/* FUN_0025617c @ 0x0025617c   (est. sk_vspace_op_e_wrap)
 * Ghidra: void FUN_0025617c(undefined8 *param_1)
 * Wrapper for op E.
 * Confidence: low
 */
void FUN_0025617c(word_t *out)
{
    word_t local[6];
    sk_vspace_dispatch2((word_t)local, 0, sk_op_1a6690);
    sk_vspace_op_wrap_copy(out, local);
}

/* FUN_002561d8 @ 0x002561d8   (est. sk_vspace_op_f)
 * Ghidra: void FUN_002561d8(void)
 * Base op F: FUN_0034b23c(); FUN_001a5c14(); FUN_0034a224().
 * Confidence: low
 */
void FUN_002561d8(word_t *out, word_t ctx)
{
    (void)out; (void)ctx;
    /* FUN_0034b23c(); FUN_001a5c14(); FUN_0034a224(); */
    sk_op_1a5c14();
}

/* FUN_0025620c @ 0x0025620c   (est. sk_vspace_op_f_wrap)
 * Ghidra: void FUN_0025620c(undefined8 *param_1)
 * Wrapper for op F.
 * Confidence: low
 */
void FUN_0025620c(word_t *out)
{
    word_t local[6];
 ...
 * Base op G: FUN_0034a48c(); FUN_001a5f6c(); FUN_0034a224().
 * Confidence: low
 */
void FUN_00256250(word_t *out, word_t ctx)
{
    (void)out; (void)ctx;
    /* FUN_0034a48c(); FUN_001a5f6c(); FUN_0034a224(); */
    sk_op_1a5f6c();
}

/* FUN_0025629c @ 0x0025629c   (est. sk_vspace_op_g_wrap)
 * Ghidra: void FUN_0025629c(undefined8 *param_1)
 * Wrapper for op G.
 * Confidence: low
 */
void FUN_0025629c(word_t *out)
{
    word_t local[6];
 ...
 * Base op H: FUN_0034a48c(); FUN_001a5f6c(); FUN_0034a224().
 * Confidence: low
 */
...
/* FUN_00256340 @ 0x00256340   (est. sk_vspace_op_h_wrap)
 * Ghidra: void FUN_00256340(undefined8 *param_1)
 * Wrapper for op H.
 * Confidence: low
 */
void FUN_00256340(word_t *out)
{
    word_t local[6];
 ...
 * Base op I: FUN_0034a48c(); FUN_001a5ee0(); FUN_0034a224().
 * Confidence: low
 */
void FUN_00256398(word_t *out, word_t ctx)
{
    (void)out; (void)ctx;
    /* FUN_0034a48c(); FUN_001a5ee0(); FUN_0034a224(); */
    sk_op_1a5ee0();
}

/* FUN_002563e4 @ 0x002563e4   (est. sk_vspace_op_i_wrap)
 * Ghidra: void FUN_002563e4(undefined8 *param_1)
 * Wrapper for op I.
 * Confidence: low
 */
void FUN_002563e4(word_t *out)
{
    word_t local[6];
 ...
 * Base op J: FUN_0034a48c(); FUN_001a5ee0(); FUN_0034a224().
 * Confidence: low
 */
...
/* FUN_00256488 @ 0x00256488   (est. sk_vspace_op_j_wrap)
 * Ghidra: void FUN_00256488(undefined8 *param_1)
 * Wrapper for op J.
 * Confidence: low
 */
void FUN_00256488(word_t *out)
{
    word_t local[6];
 ...
 * Base op K: FUN_0034a48c(); FUN_001a5e5c(); FUN_0034a224().
 * Confidence: low
 */
void FUN_002564e0(word_t *out, word_t ctx)
{
    (void)out; (void)ctx;
    /* FUN_0034a48c(); FUN_001a5e5c(); FUN_0034a224(); */
    sk_op_1a5e5c();
}

/* FUN_0025652c @ 0x0025652c   (est. sk_vspace_op_k_wrap)
 * Ghidra: void FUN_0025652c(undefined8 *param_1)
 * Wrapper for op K.
 * Confidence: low
 */
void FUN_0025652c(word_t *out)
{
    word_t local[6];
 ...
 * Base op L: FUN_0034a48c(); FUN_001a5e5c(); FUN_0034a224().
 * Confidence: low
 */
...
/* FUN_002565d0 @ 0x002565d0   (est. sk_vspace_op_l_wrap)
 * Ghidra: void FUN_002565d0(undefined8 *param_1)
 * Wrapper for op L.
 * Confidence: low
 */
void FUN_002565d0(word_t *out)
{
    word_t local[6];
 ...
 * Base op M: FUN_0034a48c(); FUN_001a5dd4(); FUN_0034a224().
 * Confidence: low
 */
void FUN_00256628(word_t *out, word_t ctx)
{
    (void)out; (void)ctx;
    /* FUN_0034a48c(); FUN_001a5dd4(); FUN_0034a224(); */
    sk_op_1a5dd4();
}

/* FUN_00256674 @ 0x00256674   (est. sk_vspace_op_m_wrap)
 * Ghidra: void FUN_00256674(undefined8 *param_1)
 * Wrapper for op M.
 * Confidence: low
 */
void FUN_00256674(word_t *out)
{
    word_t local[6];
 ...
 * Base op N: FUN_0034a48c(); FUN_001a5dd4(); FUN_0034a224().
 * Confidence: low
 */
...
/* FUN_00256704 @ 0x00256704   (est. sk_vspace_op_n_wrap)
 * Ghidra: void FUN_00256704(undefined8 *param_1)
 * Wrapper for op N.
 * Confidence: low
 */
void FUN_00256704(word_t *out)
{
    word_t local[6];
 ...
 * Base op O: FUN_0034a48c(); FUN_001a5dd4(); FUN_0034a224().
 * Confidence: low
 */
...
/* FUN_00256794 @ 0x00256794   (est. sk_vspace_op_o_wrap)
 * Ghidra: void FUN_00256794(undefined8 *param_1)
 * Wrapper for op O.
 * Confidence: low
 */
void FUN_00256794(word_t *out)
{
    word_t local[6];
 ...
 * Base op P: FUN_0034a48c(); FUN_001a5dd4(); FUN_0034a224().
 * Confidence: low
 */
...
/* FUN_00256834 @ 0x00256834   (est. sk_vspace_op_p_wrap)
 * Ghidra: void FUN_00256834(undefined8 *param_1)
 * Wrapper for op P.
 * Confidence: low
 */
void FUN_00256834(word_t *out)
{
    word_t local[6];
 ...
 * Base op Q: FUN_0034d5ec(auStack_50); FUN_001a5d34(); FUN_0034a224().
 * Confidence: low
 */
void FUN_00256888(word_t *out, word_t ctx)
{
    (void)out; (void)ctx;
    /* FUN_0034d5ec(buf); FUN_001a5d34(); FUN_0034a224(); */
    sk_op_1a5d34();
}

/* FUN_002568dc @ 0x002568dc   (est. sk_vspace_op_q_wrap)
 * Ghidra: void FUN_002568dc(undefined8 *param_1)
 * Wrapper for op Q (3-arg base call).
 * Confidence: low
 */
void FUN_002568dc(word_t *out)
{
    word_t local[6];
 ...
 * Base op R: FUN_0034d5ec(auStack_50); FUN_001a5d34(); FUN_0034a224().
 * Confidence: low
 */
...
/* FUN_00256974 @ 0x00256974   (est. sk_vspace_op_r_wrap)
 * Ghidra: void FUN_00256974(undefined8 *param_1)
 * Wrapper for op R.
 * Confidence: low
 */
void FUN_00256974(word_t *out)
{
    word_t local[6];
 ...
 * dense callback pipelines over the global jump slot DAT_00658c00.
 *==========================================================================*/

/* FUN_002569cc @ 0x002569cc   (est. sk_vspace_service)
 * Ghidra: void FUN_002569cc(void)
 ...
 * Confidence: medium
 */
void FUN_002569cc(void)
{
    long cpu = (long)sk_cpu();                 /* FUN_00083450() (est.) */
     ...
     * else { FUN_0007c1c4(); if (sk_vspace_completion() < 0) fail FUN_002a2748;
     *        else { FUN_0034f9fc(); thunk_FUN_002a2698(); } } */
    sk_free((void *)cpu);                     /* FUN_0036b118 */
    if (sk_vspace_completion() < 0) {
        sk_fatal_error(0);                    /* noreturn fail path */
    } else {
        sk_vspace_name_fin();                 /* thunk_FUN_002a2698 */
    }
}
 ...
 * noreturn (FUN_003488bc(1)/FUN_0006f768/FUN_001afe4c).
 * Confidence: medium
 */
void FUN_00256a60(void)
{
    /* FUN_003617bc(); if (extraout_x1 < 1) { FUN_00019858(); }
     * else { FUN_00351e08(); if (sk_vspace_completion() < 0) {
     *          FUN_0034a8cc(); FUN_002a2748(); FUN_003488bc(1);
 ...
 * FUN_003593c0(); FUN_0006f768(); noreturn FUN_0035a988().
 * Confidence: high (string s_Fatal_error__Call_of_deleted_met_005cfef0 matched)
 */
void FUN_00256ae4(void)
{
    sk_fatal_error(0);   /* s_Fatal_error__Call_of_deleted_met_005cfef0 noreturn */
}

/* FUN_00256b1c @ 0x00256b1c   (est. sk_deleted_method_panic2)
 * Ghidra: void FUN_00256b1c(void)
 * Same "Call of deleted method" fatal as FUN_00256ae4 (two-arg variant).
 * Confidence: high
 */
void FUN_00256b1c(void)
{
    sk_fatal_error(0, 0);   /* s_Fatal_error__Call_of_deleted_met_005cfef0 noreturn */
}

/* FUN_00256b80 @ 0x00256b80   (est. sk_vspace_io_loop)
 * Ghidra: void FUN_00256b80(undefined8 param_1, undefined8 param_2,
 *          undefined8 param_3)
 * Dense IO/service loop: current-CPU framing (FUN_0008e518) then a long chain
 * of vspace callback invocations through the global jump slot DAT_00658c00 and
 ...
 */
void FUN_00256b80(word_t a, word_t b, word_t c)
{
    (void)a; (void)b; (void)c;
    /* FUN_0008e518(); ... 40+ vspace helper calls through DAT_00658c00 and
    ...
    (*(void (**)(void))(0x658c00))();   /* DAT_00658c00 */
    sk_fatal_error(0);                  /* failure tail (noreturn) */
}

/* FUN_00256f20 @ 0x00256f20   (est. sk_vspace_io_loop_short)
 * Ghidra: void FUN_00256f20(void)
 * Thin trampoline: jumps into FUN_00256f34 (the shared IO dispatch).
 * Confidence: medium
 */
void FUN_00256f20(void)
{
    FUN_00256f34();
}

/* FUN_00256f34 @ 0x00256f34   (est. sk_vspace_io_dispatch)
 * Ghidra: void FUN_00256f34(void)
 ...
 * (jumptable not recoverable at 0x0025701c). Includes FUN_00257020().
 * Confidence: low (jumptable lost; indirect calls)
 */
void FUN_00256f34(void)
{
    /* FUN_0008e518(); FUN_00350c5c(); FUN_00352ee4(); FUN_00350920();
     * FUN_0031b080(); FUN_00354534(); FUN_0034e56c(); FUN_00257020();
...
/* FUN_00257020 @ 0x00257020   (est. sk_vspace_io_loop_deep)
 * Ghidra: void FUN_00257020(void)
 ...
 * noreturn (FUN_00350410/FUN_003488bc/FUN_0006f768), success ends with the
 * thread epilogue FUN_0008e500.
 * Confidence: low (opaque callback pipeline, indirect dispatch)
 */
void FUN_00257020(void)
{
    /* FUN_0008e518(); ... ~60 helper calls through DAT_00658c00 and the
     ...
     * Failure -> FUN_00350410(); FUN_003488bc(); FUN_0006f768(); noreturn.
     * Success -> FUN_0008e500(). */
    (*(void (**)(void))(0x658c00))();
    sk_vspace_fail(1);   /* FUN_003488bc() failure path */
    sk_fatal_error(0);
}

/* FUN_0025785c @ 0x0025785c   (est. sk_vspace_io_exit)
 * Ghidra: void FUN_0025785c(void)
 * IO exit path: current-CPU framing, then either a queued work dispatch
 * (FUN_000e15d8 -> FUN_00256f20) or a single-item dispatch through the
 * context function pointer (FUN_0034e4a4 -> FUN_00256f20 -> epilogue).
 * Ends with repeated thunk_FUN_00012568 releases and FUN_0008e500.
 * Confidence: low (opaque teardown pipeline)
 */
void FUN_0025785c(void)
{
    /* FUN_0008e518(); auVar3 = FUN_00357e84();
     * if ((auVar3._8_8_ & 1) == 0) { FUN_000e15d8(...); FUN_00256f20(); }
     * else { dispatch via (*ctx)(); FUN_0008e388(); FUN_00352ea8();
     *        FUN_00256f20(); FUN_00351160(); (*x8)(); }
     * thunk_FUN_00012568() x4; FUN_0008e500(); thunk_FUN_00012568(). */
    FUN_00256f20();
}

/* FUN_00257908 @ 0x00257908   (est. sk_vspace_io_loop4)
 * Ghidra: void FUN_00257908(undefined8 param_1, undefined8 param_2,
 ...
 */
void FUN_00257908(word_t a, word_t b, word_t c, word_t d)
{
...
/* FUN_00257f8c @ 0x00257f8c   (est. sk_vspace_io_sweep)
 * Ghidra: void FUN_00257f8c(void)
...
static inline unsigned long sk_bit_reverse(unsigned long v)
{
...
/* FUN_00258250 @ 0x00258250   (est. sk_set_clear_slots)
 * Ghidra: void FUN_00258250(void)
...
void FUN_00258250(void)
{
    ...
    sk_free(0);   /* FUN_0036b118 representative */
}

/* FUN_0025837c @ 0x0025837c   (est. sk_set_clear_slots2)
 * Ghidra: void FUN_0025837c(void)
...
/* FUN_002584a8 @ 0x002584a8   (est. sk_set_clear_slots3)
 * Ghidra: void FUN_002584a8(void)
...
/* FUN_002586c4 @ 0x002586c4   (est. sk_set_clear_slots5)
 * Ghidra: void FUN_002586c4(void)
...
/* FUN_002587e0 @ 0x002587e0   (est. sk_set_walk_and_apply)
 * Ghidra: void FUN_002587e0(undefined8 param_1, uint param_2, long param_3)
 * The core slot-set walk: loads the bitmap at (set+0x40), and for every set
 * bit (MSB-first via sk_bit_reverse+LZCOUNT) invokes either the read-callback
 ...
 */
void FUN_002587e0(word_t param_1, uint32_t apply_and_clear, long set)
{
    (void)param_1;
    ...
    for (;;) {
        while (bm != 0) {
            unsigned long r = sk_bit_reverse(bm);
            bm = bm - 1 & bm;
            ...
            if (apply_and_clear & 1) {
                ...
                if ((*(uint8_t *)(set + 0x20) & 0x3f) < 6)
                    *slot_bitmap = -1L << (nb & 0x3f);
                    ...
                    sk_set_alloc_fill(0, (nb + 0x3f) >> 6, (unsigned long)slot_bitmap);
                *(long *)(set + 0x10) = 0;
            }
            sk_free((void *)set);   /* FUN_0036b118 */
            return;
        }
...
/* FUN_00258b20 @ 0x00258b20   (est. sk_set_walk_apply_set)
 * Ghidra: void FUN_00258b20(undefined8 param_1, undefined8 param_2)
 * FUN_002587e0(param_1, 1, param_2): walk-and-apply that also clears the
 * bitmap (write/clear pass).
 * Confidence: medium
 */
void FUN_00258b20(word_t a, word_t set)
{
    FUN_002587e0(a, 1, set);
}

/* FUN_00258b2c @ 0x00258b2c   (est. sk_set_walk_apply_clear)
 * Ghidra: void FUN_00258b2c(undefined8 param_1, undefined8 param_2)
 * FUN_002587e0(param_1, 0, param_2): walk-and-apply that leaves the bitmap
 * intact (read pass).
 * Confidence: medium
 */
void FUN_00258b2c(word_t a, word_t set)
{
    FUN_002587e0(a, 0, set);
}

/* FUN_00258b88 @ 0x00258b88   (est. sk_set_membership)
 * Ghidra: bool FUN_00258b88(undefined8 param_1, undefined8 param_2,
 *          code *param_3)
 ...
 */
bool FUN_00258b88(word_t a, word_t b, void (*cb)(void))
{
    (void)a; (void)b;
 ...
 * FUN_001fc0f4(param_3); otherwise dispatches FUN_00258b2c (clear pass) or
 * FUN_00258b20 (set pass) based on the flag. Returns x21 < x19.
...
bool FUN_00258c60(word_t a, word_t b, word_t c)
{
     ...
     * else if (!(v&1)) { FUN_00356c3c(); FUN_00258b2c(); }
     * else { FUN_00356c3c(); FUN_00258b20(); }
     * return x21 < x19; */
    return false;
}
 ...
 * Set-fatal: FUN_003488bc(1); noreturn FUN_0034a238().
 * Confidence: high (pure fatal path)
 */
void FUN_00258cf0(void)
{
    sk_vspace_fail(1);   /* FUN_003488bc(1) */
    sk_fatal_error(0);   /* FUN_0034a238 noreturn */
}

/* FUN_00258d10 @ 0x00258d10   (est. sk_set_apply_slot)
 * Ghidra: void FUN_00258d10(undefined8 param_1, undefined8 param_2,
 ...
 * Confidence: medium
 */
void FUN_00258d10(word_t a, word_t b, word_t c, long set, word_t e,
                  word_t f, word_t g)
{
...
/* FUN_00258d9c @ 0x00258d9c   (est. sk_set_apply_two)
 * Ghidra: void FUN_00258d9c(undefined8 param_1, uint param_2, long *param_3,
 ...
 * combined write path (FUN_00259954) or (else) the aux callback and a
 * buffer copy (FUN_001f0700). param_2&1 selects the variant.
 * Confidence: medium (two-buffer slot apply recovered)
 */
void FUN_00258d9c(word_t a, uint32_t variant, long *out, long slot,
                  word_t e, long page, long aux, word_t h)
{
     ...
     *   if (variant & 1) { FUN_0035bc70(...); FUN_00259954(slot,*out,page,aux,h);} }
    ...
    if (variant & 1) {
        FUN_00259954(slot, *out, page, aux, h);
    }
}

/* FUN_0025902c @ 0x0025902c   (est. sk_set_apply_dispatch)
 * Ghidra: void FUN_0025902c(undefined8 param_1, undefined8 param_2,
 *          undefined8 param_3, long param_4)
 * Dispatch wrapper for a slot apply: CPU framing, then FUN_001fbb74; on the
 * set flag runs the page callback (*(*(lVar2-8)+0x20)); then FUN_00258d9c and
 * the completion epilogue.
 * Confidence: low (dense dispatch pipeline)
 */
void FUN_0025902c(word_t a, word_t b, word_t c, long set)
{
    (void)a; (void)b; (void)c;
    /* FUN_0008e518(); lVar2 = *(set+0x18); FUN_00350488(); FUN_00310d68();
     * FUN_00348e00(); FUN_0007c1a4(); (*DAT_00658c00)(); FUN_0034b0c4();
     * FUN_001fbb74(...); if (flag) (**(*(lVar2-8)+0x20))();
     * FUN_00352480(); FUN_000839d8(); FUN_00258d9c(); FUN_0034dfe4();
     * (**(*(x16_00+8)))(...); FUN_0008e500(); */
    FUN_00258d9c(0, 0, 0, 0, 0, 0, 0, 0);
    (*(void (**)(void))(0x658c00))();
}

/* FUN_002591b4 @ 0x002591b4   (est. sk_set_grow)
 * Ghidra: void FUN_002591b4(void)
...
/* FUN_0025941c @ 0x0025941c   (est. sk_set_collect)
 * Ghidra: undefined8 * FUN_0025941c(ulong *param_1, long param_2, long param_3,
 ...
 */
word_t *FUN_0025941c(word_t *bitmap, long nwords, long remaining, word_t *out,
                     long page, long aux, word_t ctx)
{
    word_t *res = out;
    if (remaining == 0) {
        res = (word_t *)&DAT_00657798;   /* &DAT_00657798 sentinel */
    } else if ((long)remaining == (long)out[2]) {
        /* FUN_0036b270(out); res = out; */
        sk_alloc_pages(0, 0);
    } else {
        res = (word_t *)sk_hash_slot(remaining, page, aux, ctx);  /* FUN_001ee140 */
        long i = 0;
...
/* FUN_0025969c @ 0x0025969c   (est. sk_set_lookup)
 * Ghidra: void FUN_0025969c(void)
 ...
 */
void FUN_0025969c(void)
{
    /* FUN_00351708(); FUN_0034e39c(); (*DAT_00658c00)();
...
/* FUN_00259770 @ 0x00259770   (est. sk_set_get_value)
 * Ghidra: undefined8 FUN_00259770(long param_1, long param_2)
 ...
 * Confidence: medium
 */
word_t FUN_00259770(long idx, long set)
{
    /* lVar4 = *(set+0x10); lVar7 = *(lVar4-8); (*DAT_00658c00)(*(lVar7+0x40));
    ...
    sk_vspace_cb_sel();   /* FUN_0001a1c8 */
    return sk_swift_hash_combine(0, idx, 0);   /* FUN_0031948c */
}

/* FUN_002598b0 @ 0x002598b0   (est. sk_set_copy_range)
 * Ghidra: void FUN_002598b0(long param_1, long param_2, long param_3)
 ...
 * Confidence: medium
 */
void FUN_002598b0(long from, long to, long set)
{
    ...
    sk_buf_range(from, to, 0);     /* FUN_001f7d28 */
    sk_buf_range2(from, 0);        /* FUN_001f0bb4 */
    sk_elem_map(0, 0, 0, 0);       /* FUN_0019ce60 */
}

/* FUN_00259954 @ 0x00259954   (est. sk_set_remove)
 * Ghidra: void FUN_00259954(undefined8 param_1, undefined8 param_2,
 *          undefined8 param_3, long param_4, undefined8 param_5)
...
void FUN_00259954(word_t a, word_t b, word_t c, long set, word_t e)
{
    ...
    /* FUN_0008e518(); FUN_00352914(); FUN_00349720(); (*DAT_00658c00)(...);
...
/* FUN_00259b64 @ 0x00259b64   (est. sk_set_filter)
 * Ghidra: void FUN_00259b64(undefined8 *param_1, long param_2, undefined8
 ...
 */
void FUN_00259b64(word_t *out, long out_bitmap, word_t a, long set,
                  ...
                  long aux, word_t h)
{
    ...
    for (;;) {
        if (bm == 0) {
            ...
            if ((long)nwords <= next) {
                *out = (word_t)FUN_0025941c((word_t *)out_bitmap, a, filled,
...
/* FUN_00259e60 @ 0x00259e60   (est. sk_set_op_wrap)
 * Ghidra: void FUN_00259e60(undefined8 *param_1)
 * Wrapper: thunk_FUN_001fca54(&local, *x20) then copies the 5-word (0x28-byte)
 * result into param_1[0..4].
 * Confidence: medium
 */
void FUN_00259e60(word_t *out)
{
    word_t local[5];
    sk_set_buf_pack((unsigned long)local, 0, 0);   /* thunk_FUN_001fca54 */
    memcpy(out, local, sizeof(local));
}

/* FUN_00259ea8 @ 0x00259ea8   (est. sk_set_next)
 * Ghidra: void FUN_00259ea8(long param_1, long param_2)
...
/* FUN_0025a060 @ 0x0025a060   (est. sk_set_descriptor)
 * Ghidra: void FUN_0025a060(long param_1)
 ...
 * Set-descriptor init tail: FUN_001fab14(); FUN_0034c988(); FUN_0025e5d0().
 * Confidence: low (opaque init chain)
 */
void FUN_0025a094(void)
{
    /* FUN_001fab14(); FUN_0034c988(); FUN_0025e5d0(); */
    sk_object_lock(0, 0, 0, 0, 0);
}

/* FUN_0025a17c @ 0x0025a17c   (est. sk_set_for_each2)
 * Ghidra: void FUN_0025a17c(void)
...
/* FUN_0025a2a0 @ 0x0025a2a0   (est. sk_set_for_each3)
 * Ghidra: void FUN_0025a2a0(undefined8 param_1, undefined8 param_2, long
 ...
 * Confidence: low (dense for-each pipeline)
 */
void FUN_0025a2a0(word_t a, word_t b, long set, word_t c, word_t d)
{
    (void)a; (void)b; (void)c; (void)d;
    /* FUN_0008e518(); FUN_00349a68(); (*DAT_00658c00)(...); FUN_00348f38();
...
/* FUN_0025a4cc @ 0x0025a4cc   (est. sk_set_clear2)
 * Ghidra: void FUN_0025a4cc(void)
...
/* FUN_0025a6a8 @ 0x0025a6a8   (est. sk_set_clear3)
 * Ghidra: void FUN_0025a6a8(void)
 ...
 * (FUN_0035620c/FUN_0025af6c); on completion re-fills the bitmap (via
 * FUN_00354948 / FUN_001b5474) and resets the count.
 * Confidence: medium
 */
void FUN_0025a6a8(void)
{
    /* FUN_0008e518(); FUN_003499f0(); (*DAT_00658c00)(...); FUN_00348f38();
     * lVar6 = *x20; ... scan bitmap@(lVar6+0x38); for each set bit:
     *   FUN_00353c24(*(x16+0x20), v, slot_addr); (*x8_03)();
     *   FUN_0035620c(); FUN_00352a58(); FUN_0025af6c();
...
{
    (void)a; (void)b;
    /* FUN_001fab14(b); FUN_0034c988(); FUN_0025e5d0(); */
    sk_object_lock(0, 0, 0, 0, 0);
}

/* FUN_0025a864 @ 0x0025a864   (est. sk_set_insert_key)
 * Ghidra: void FUN_0025a864(undefined8 *param_1, long param_2)
 ...
 * FUN_0025bddc(0x673a80). On a free slot, sets the bit and copies the 5-word
 * key in; increments the count.
 * Confidence: medium (open-addressing hash-set insert recovered)
 */
void FUN_0025a864(word_t *key, long set)
{
     ...
     *   if equal -> FUN_0025bddc(0x673a80) duplicate panic;
     *   uVar3++;  (linear probe) */
    sk_set_dup_panic(0x673a80);   /* duplicate-key panic (string addr) */
}

/* FUN_0025aa90 @ 0x0025aa90   (est. sk_set_insert_word)
 * Ghidra: void FUN_0025aa90(long param_1, long param_2)
 ...
 * FUN_0025bddc(0x674278); otherwise sets the bit, stores the word and bumps
 * the count.
 * Confidence: medium (open-addressing word-set insert)
 */
void FUN_0025aa90(long key, long set)
{
    unsigned long h = sk_set_hash();   /* thunk_FUN_00229ebc(hash_fn, key) */
    unsigned long idx = h;
    for (;;) {
    ...
    sk_set_dup_panic(0x674278);   /* duplicate-key panic */
}

/* FUN_0025ab30 @ 0x0025ab30   (est. sk_set_insert_pair)
 * Ghidra: void FUN_0025ab30(long param_1, ulong param_2, long param_3)
 ...
 * (FUN_001b9084 + FUN_001a8564) seeded by the IV words at DAT_006adf10/18,
 * linearly probes comparing stored pairs; a match is a duplicate -> panic
 * FUN_0025bddc(0x6753a0); else stores {param_1,param_2} and bumps the count.
 * Confidence: medium (open-addressing pair-set insert + hash)
 */
void FUN_0025ab30(long a, word_t b, long set)
{
    /* SHA-512-style seed constants (DAT_006adf10 ^ "sompesu"/"arenegyl"/...):
     ...
     *   idx++; */
    sk_swift_string_hash();   /* FUN_001a8564 */
    sk_swift_string_cmp(0, 0, 0, 0, 0);   /* FUN_002a0d50 */
    sk_set_dup_panic(0x6753a0);
}
 ...
 * 0x28). Same open-addressing probe as FUN_0025a864; duplicate -> panic
 * FUN_0025bddc(0x673a80).
 * Confidence: medium
 */
void FUN_0025acb8(word_t *key, long set)
{
    (void)set;
    /* identical structure to FUN_0025a864: hash (FUN_0008e5d8 +
     * FUN_0031993c), linear probe comparing via FUN_0031996c/FUN_0031997c,
     * store 5-word key at data+idx*0x28, count++, duplicate panic
     * FUN_0025bddc(0x673a80). */
    sk_set_dup_panic(0x673a80);
}
 ...
 * FUN_0025bddc(0x677880). Mirror of FUN_0025aa90.
 * Confidence: medium
 */
void FUN_0025aecc(long key, long set)
{
    unsigned long idx = sk_set_hash();   /* thunk_FUN_00229ebc(hash_fn, key) */
    for (;;) {
        idx &= ~(-1L << ((*(uint8_t *)(set + 0x20)) & 0x3f));
        unsigned long w = *(unsigned long *)(set + 0x38 + (idx >> 6) * 8);
        unsigned long bit = 1UL << (idx & 0x3f);
...
/* FUN_0025af6c @ 0x0025af6c   (est. sk_set_insert_pipeline)
 * Ghidra: void FUN_0025af6c(void)
 ...
 * permanent it tails into the duplicate panic FUN_0025bddc.
 * Confidence: low (dense insert pipeline)
 */
void FUN_0025af6c(void)
{
    /* FUN_0008e518(); FUN_00350dd4(); FUN_00349720(); (*DAT_00658c00)(...);
     ...
     * FUN_0025bddc() noreturn duplicate panic. */
    (*(void (**)(void))(0x658c00))();
    sk_set_dup_panic(0);
}

/* FUN_0025b0e0 @ 0x0025b0e0   (est. sk_set_clear4)
 * Ghidra: void FUN_0025b0e0(void)
 ...
 * FUN_0025ab30 (pair-insert) to re-seed; resets the count.
 * Confidence: low (opaque clear pipeline)
 */
void FUN_0025b0e0(void)
{
    /* FUN_0008e518(); FUN_0034fb14(); FUN_003557ec(); FUN_0034c988();
     * FUN_0025e4a0(); FUN_00353584(); iterate bitmap@(x19+0x38): for each
     * set bit i: thunk_FUN_0036b270(data[i*0x10+8]); FUN_0034c6b4();
     *   FUN_0025ab30();  -- pair re-seed. done -> *x20 = x21. */
    sk_alloc_pages(0, 0);   /* thunk_FUN_0036b270 */
    FUN_0025ab30(0, 0, 0);
}
