...
extern word_t FUN_0006ae9c(); /* out of slice 0x6ae9c */
...
extern word_t FUN_002b3978(); /* out of slice 0x2b3978 */
extern word_t FUN_002b3b50(); /* out of slice 0x2b3b50 */
extern word_t FUN_002b3cf8(); /* out of slice 0x2b3cf8 */
extern word_t FUN_002b3f40(); /* out of slice 0x2b3f40 */
...
extern word_t FUN_00350b3c(); /* out of slice 0x350b3c */
...
extern word_t FUN_003514e8(); /* out of slice 0x3514e8 */
...
extern word_t FUN_0035638c(); /* out of slice 0x35638c */
extern word_t FUN_00356bb0(); /* out of slice 0x356bb0 */
extern word_t FUN_003583e8(); /* out of slice 0x3583e8 */
...
extern word_t FUN_00467848(); /* out of slice 0x467848 */
            ...
            do {
                while (1) {
                    ...
                    if ((v11 >> 0xe) == (v2 >> 0xe)) {
                        ...
                        v12 = FUN_002b3f40(p5, l17, v14, v9, v14, p3, p4);
                        v8 = 0;
                        v13 = w1_00;
                        goto LAB_0046f260;
                    }
                ...
                FUN_003504a0(v10);
                w19 = FUN_002b439c();
                a21_lo = sk_bcg_0046f298(w19.lo, w19.hi, l16);
                FUN_003a25d4(w19.hi);
                l1 = 0;
                if (a21_flag != 1) {
                    l1 = (long)a21_lo;
...
static void sk_bcg_0046f3f4(word_t p1, word_t p2, word_t p3, word_t p4,
                            word_t p5, word_t p6)
{
    word_t r1;
    ...
    r1 = thunk_FUN_002b74c0(p5, p6, pair.lo, pair.hi, p3, p4);
    FUN_004abf6c();
...
static void sk_bcg_0046f474(word_t obj)
{
...
static void sk_bcg_0046f54c(word_t p1, word_t p2, word_t p3, word_t p4)
{
    ...
    code   *fnp16;                    /* extraout_x16 / _00 / _01 base */
 ...
 * Confidence: low   Notes: heavy extraout_xN register aliasing; masked
 * self-modifying trampoline calls (SUB_54ffff60f100041f) */
static void sk_bcg_0046f820(word_t param_1, word_t param_2, word_t param_3)
{
...
static void sk_bcg_0046fb9c(word_t param_1, word_t param_2, word_t param_3)
{
    ...
    code   *fnp16;                    /* extraout_x16 / _00 / _01 / _02 base */
    wpair_t pr;
    word_t status;
...
static void sk_bcg_00470644(void);
...
static void sk_bcg_00470ff8(void);
static void sk_bcg_0047153c(void);
static void sk_bcg_00471644(void);
static void sk_bcg_00471aec(void);
...
static void sk_bcg_0047042c(void)
{
    ...
    t1 = (word_t)FUN_00377824(t1, in_x3);
    FUN_00464f4c();
    FUN_003510b8();
    t2 = t1;
    FUN_00377bec();
...
static void sk_bcg_00470644(word_t p1, word_t p2, word_t p3, word_t p4)
{
    ...
    t3 = (word_t)FUN_00377824(t3, t2, p3);
...
static void sk_bcg_00470ff8(word_t p1, word_t p2, long p3)
{
    ...
    word_t e_x16c;              /* extraout_x16_01 */
    code x8fn1, x8fn2, x8fn3, x8fn4, x8fn5, x8fn6, x8fn7, x8fn8, x8fn9; /* extraout_x8_0* */
    ...
    t14 = *(word_t *)(p3 + 0x10);
    t2 = (word_t)FUN_00377824(0xff, t2, t14, &DAT_00611b24, &LAB_00611b34);
    FUN_003508e4();
    ...
    t11 = *(word_t *)(p3 + 0x28);
    FUN_003505c4(0);
    t4 = (word_t)FUN_00377824();
    FUN_000a6f88();
    FUN_0007c1a4();
    ((code)&SUB_54ffff60f100041f)();                           /* masked trampoline fn */
    FUN_0034cff4();
    t5 = (word_t)FUN_004aa47c();
    t5 = (word_t)FUN_00377824(t5, t13, t14);
    FUN_000a6f88();
    FUN_0007c1a4();
    ((code)&SUB_54ffff60f100041f)();                           /* masked trampoline fn */
    ...
    do {
        ...
        a15 = (wpair_t)x8fn5();      /* auVar15 = (*extraout_x8_06)() */
                            ...
                            word_t p9, word_t p10, word_t p11, word_t p12)
{
    ...
    word_t t2;                  /* uVar2 */
    ulong local_60, local_58;   /* bounds */
    ...
    if ((local_58 >> 0xe) <= (local_60 >> 0xe)) {
        sk_bcg_00471644(p1, p2, local_58, local_60, (code)p3, p4, p5, p6, p7, p8, p9, p10, p11, p12);
        return;
    }
...
static void sk_bcg_00472974(word_t param_1, word_t param_2, long param_3, word_t param_4, code *param_5)
{
    ...
    av11 = FUN_004aa5dc();
    v4 = FUN_00377824(av11.lo, av11.hi, istk_00000080);
    FUN_000a6f88();
    ...
    for (; ln6 = thunk_FUN_0001612c(param_4, v4), param_3 != ln6; param_3 = param_3 + 1) {
        ...
        pc9 = (code *)FUN_000277e8(istk_00000088);
        av11 = (*pc9)(astk_28);
        (**(code **)(x16_1 + 0x10))(x9_1, av11.hi, v4);   /* extraout_x16_00, extraout_x9_01 */
        (*av11.lo)(astk_28, astk_28, 0);   /* indirect call via av11._0_8_ */
        FUN_0009e234();
        v8 = (*param_5)();
        pc9 = *(code **)(x16_1 + 8);
        FUN_00350618();
    ...
    if (ln6 == param_3) {
        ...
        FUN_00464f4c();
        av11 = FUN_00350914();
        v2 = FUN_00377bec(av11.lo, av11.hi, v3);
        FUN_0035166c();
        FUN_000b4390();
        FUN_0035053c();
...
static void sk_bcg_00472f44(void)
{
    ...
    FUN_0034ab10();
    FUN_0034b540();
    av6 = (*((code *)(uintptr_t)0x54ffff60f100041f))();   /* masked trampoline */
    loc_8 = av6.lo;
...
static void sk_bcg_0047c1b0(void)
{
    word_t pcVar1;
    word_t in_ZR;
    word_t lVar2, lVar6;
