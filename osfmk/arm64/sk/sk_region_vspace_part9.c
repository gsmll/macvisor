...
#define SoftwareBreakpoint(code, addr)  ((void)__builtin_trap())
#define SCARRY8(a, b)   (__builtin_add_overflow((a), (b), (unsigned long *)&(unsigned long){0}))
#define SBORROW8(a, b)  (__builtin_sub_overflow((a), (b), (unsigned long *)&(unsigned long){0}))

static inline unsigned long sk_clz64(uint64_t x) { return (unsigned long)__builtin_clzll(x); }
static inline uint64_t sk_bitreverse(uint64_t x)
{
...
static inline unsigned long sk_lowbit_idx(uint64_t word, unsigned long word_index)
{ return sk_clz64(sk_bitreverse(word)) | (word_index << 6); }
...
static inline void *sk_self_reg(void) { return *(void * volatile *)0; }

/*--------------------------------------------------------------------*/
/* Out-of-range cL4/Swift-runtime helpers (descriptive name + FUN_ addr). */
/*--------------------------------------------------------------------*/
extern void *sk_cpu(void);                                          /* FUN_0008e518 */
extern void sk_thread_epilogue(void *, void *, void *);             /* FUN_0008e500 */
extern void sk_thread_prologue(void);                               /* FUN_00084220 */
extern void sk_thread_epilogue_2(void *, ...);                      /* FUN_00084234 */
extern unsigned long sk_thread_aux(void *, ...);                    /* FUN_000839d8 */
extern void sk_fatal_error(unsigned long, unsigned long, ...)
    __attribute__((noreturn));                                      /* FUN_001afe4c */
extern void *sk_alloc_pages(unsigned long size, unsigned long tag); /* FUN_0036b270 (thunk) */
...
extern unsigned long sk_swift_string_cmp(unsigned long, unsigned long,
                                         unsigned long, unsigned long,
                                         unsigned long, ...);       /* FUN_002a0d50 */
extern unsigned long sk_swift_string_advance(unsigned long, unsigned long, ...); /* FUN_002a4c98 */
extern unsigned long sk_swift_string_next(unsigned long, unsigned long,
                                          unsigned long, void *, void *); /* FUN_002a49a8 */
extern unsigned long sk_swift_utf8_char(unsigned long, unsigned long,
...
extern void sk_swift_string_index_next(void);                       /* FUN_00274b4c */
extern unsigned long sk_swift_string_buf_grow(void *, unsigned long, unsigned long,
                                              void *);              /* FUN_001a0908 */
extern void sk_swift_buf_free(unsigned long, ...);                  /* FUN_000026e8 */
extern void sk_swift_elem_release(unsigned long, ...);              /* FUN_003199ac */
extern unsigned long sk_swift_hash_combine(unsigned long, unsigned long,
                                           unsigned long, ...);     /* FUN_0031993c */
extern unsigned long sk_swift_hash_cmp(unsigned long, unsigned long,
                                       unsigned long, ...);         /* FUN_0031997c */
extern unsigned long sk_swift_elem_copy(unsigned long, ...);        /* FUN_0006a4c0 */
extern unsigned long sk_swift_hash_apply(unsigned long, ...);       /* FUN_0008e5d8 */
extern void *sk_swift_alloc(unsigned long, ...);                    /* FUN_00354948 */
extern unsigned long sk_set_hash(unsigned long, ...);                /* thunk_FUN_00229ebc */
extern void sk_set_dup_panic(unsigned long msg);                    /* FUN_0025bddc */
extern long sk_set_descriptor(void *);                              /* FUN_0025a060 */
extern unsigned long sk_buf_range(unsigned long, unsigned long, unsigned long); /* FUN_001f7d28 */
extern void sk_elem_map(unsigned long, unsigned long, unsigned long, unsigned long); /* FUN_0019ce60 */
extern unsigned long sk_set_alloc_fill(unsigned long, unsigned long, unsigned long, ...); /* FUN_001b5474 */
extern unsigned long sk_set_bitmap_zero(unsigned long, unsigned long, unsigned long,
                                        unsigned long);            /* FUN_00012568 */
extern unsigned long sk_set_bitmap_alloc(unsigned long, unsigned long); /* FUN_00229ebc */
extern unsigned long sk_set_capacity(unsigned long);                     /* FUN_001fb05c */
extern unsigned long sk_swift_alloc_buf(unsigned long, unsigned long, ...); /* FUN_0036a940 */
extern unsigned long sk_set_slot_next(unsigned long, ...);          /* FUN_00310d68 */
extern void sk_vspace_fail(unsigned long, ...);                     /* FUN_003488bc */
extern unsigned long sk_swift_unicode_len(unsigned long, ...);      /* FUN_003d31f8 */
extern unsigned long sk_unicode_scalar(unsigned long, unsigned long, ...); /* FUN_003d3550 */

/* Sibling slice (part 8) functions this region calls into. */
extern void sk_set_resize_16(void *, unsigned long, unsigned long, void *); /* FUN_0025a3c8 */
extern void sk_set_resize_16b(void *, unsigned long, unsigned long, void *); /* FUN_0025a4cc */
extern void sk_set_resize_40(void *, unsigned long, unsigned long, void *); /* FUN_0025a5c4 */
extern void sk_set_copy_self(void *, unsigned long, unsigned long, void *); /* FUN_0025a6a8 */
extern void sk_set_alloc_re(void *, unsigned long, unsigned long, void *); /* FUN_0025a840 */
extern void sk_set_copy_sel(void *, unsigned long, unsigned long, void *); /* FUN_0025a864 */
extern void sk_set_copy_pol(void *, unsigned long, unsigned long, void *); /* FUN_0025aa90 */
extern void sk_set_copy_pol16(void *, unsigned long, unsigned long, void *); /* FUN_0025acb8 */
extern void sk_set_copy_pol40(void *, unsigned long, unsigned long, void *); /* FUN_0025aecc */
extern void sk_set_insert_done(void *, unsigned long, unsigned long, void *); /* FUN_0025af6c */
extern void sk_set_resize_self(void *, unsigned long, unsigned long, void *); /* FUN_0025b0e0 */

/*------------------------------------------------------------------------*
 * Set-copy family (8-byte elements).
 *------------------------------------------------------------------------*/

/* FUN_0025b1c8 @ 0x0025b1c8   (est. sk_set_copy_apply8)
 ...
 * via FUN_0025e370. Element load via FUN_0031996c + closure call.
 * Confidence: medium
 * Notes: register-inout set; SoftwareBreakpoint on index overflow.
 */
void sk_set_copy_apply8(void)
{
     ...
     * Swift runtime entry; uVar3 = FUN_0025e370() (dest alloc). */
    uint64_t result = 0;   /* FUN_0025e370() */
    ...
    sk_free(NULL);   /* FUN_0036b118 representative */
    return;
}

/* FUN_0025b294 @ 0x0025b294   (est. sk_set_copy_apply8b)
 ...
 * Confidence: medium
 * Notes: FUN_0025e538 allocates; FUN_001fab14 grows the buffer;
 *   SoftwareBreakpoint on overflow.
 */
void sk_set_copy_apply8b(void)
{
    ...
    sk_thread_prologue();
    long dst = (long)sk_self_reg();   /* *unaff_x20 */
    long cap = 0;
    (void)dst; (void)cap;
    sk_thread_epilogue_2(0);
}

/* FUN_0025b36c @ 0x0025b36c   (est. sk_set_copy_apply16)
 * Ghidra: undefined FUN_0025b36c(void)
 ...
 * Confidence: medium
 * Notes: SoftwareBreakpoint on overflow; FUN_0025a840 is sibling resize.
 */
void sk_set_copy_apply16(void)
{
    /* FUN_0008e518(); FUN_00349734(); (*DAT_00658c00)(x8+0x40);
...
/* FUN_0025b4e8 @ 0x0025b4e8   (est. sk_set_copy16)
 * Ghidra: undefined FUN_0025b4e8(void)
 * Copies a 16-byte-element set into a destination set (x21): seeds the
 * destination with the source size/hash (FUN_0025e4a0) and copies each live
 ...
 *   capacity check.
 */
void sk_set_copy16(void)
{
    /* FUN_00084220(); dst=*x20;
     * FUN_003557ec(*(dst+0x20), *(dst+0x24), *(dst+0x28)); FUN_0025e4a0();
...
/* FUN_0025b5e0 @ 0x0025b5e0   (est. sk_set_copy40)
 * Ghidra: undefined FUN_0025b5e0(void)
 * Copies a 40-byte-element (0x28 stride) set into destination x21: seeds via
 * FUN_0025e370 and copies all five words of each live element from source x19
...
{
    /* FUN_003565a8(); FUN_0034b930(); FUN_0025e370(); FUN_00353584();
...
/* FUN_0025b6d4 @ 0x0025b6d4   (est. sk_set_copy16_rev)
 ...
 * sk_bitreverse), copies the element to destination x21 (+0x30). Stores dest.
 * Confidence: medium
 * Notes: FUN_0025e538 allocates destination; FUN_0034c53c seeds.
 */
void sk_set_copy16_rev(void)
{
    /* FUN_0034b930(); FUN_0025e538(); FUN_00353584();
     * if (extraout_x8!=0) { FUN_0034f818(x21+0x38); check;
     *   *(x21+0x10)=*(x19+0x10); FUN_0034c53c(0);
     *   uVar2 = mask & *(x19+0x38);
     *   walk bitmap lowbit-first: uVar5=sk_lowbit_idx(bm,i);
...
/* FUN_0025b7d8 @ 0x0025b7d8   (est. sk_set_copy8_rev)
 * Ghidra: undefined FUN_0025b7d8(void)
 * Copies an 8-byte-element set with low-bit-first traversal: for each live
 * element of source x9, copies it to destination (FUN_0025b994), preserving
 ...
 */
void sk_set_copy8_rev(void)
{
    /* FUN_0008e518(); FUN_00349734(); (*DAT_00658c00)(x8+0x40);
     * auVar12=FUN_003490ec(); FUN_00350530(a,b,*(a+0x18));
     * FUN_0031d3a4(); dst=*x20; lVar5=FUN_0025b994(dst);
     * if (*(dst+0x10)==0) { FUN_0036b118(dst); *x20=lVar5; FUN_0008e500(); return; }
...
/* FUN_0025b994 @ 0x0025b994   (est. sk_set_alloc8)
 * Ghidra: undefined FUN_0025b994(long param_1)
 * Allocates an 8-byte-element set with the size/hash taken from the source
 * set (param_1+0x20/+0x24/+0x28) via FUN_0025e5d0. Wrapper allocator.
 * Confidence: medium
 */
void sk_set_alloc8(long src_set)
{
    /* FUN_0025e5d0(*(src+0x20), *(src+0x24), *(src+0x28), 0); */
    sk_swift_alloc(0);   /* FUN_0025e5d0 representative */
    (void)src_set;
}
 ...
 * FUN_0025b7d8 (copy8); otherwise dispatches FUN_0025b36c (copy16) or the
 * sibling FUN_0025a6a8 based on the NG/OV flag. Returns x21 < x19.
 * Confidence: low (flag-selected copy)
 */
bool sk_set_copy_dispatch(void)
{
    /* FUN_00355d4c(); if (NG==OV) { if (!(v&1)) FUN_0025b7d8(p3); }
     * else if (!(v&1)) { FUN_00356c3c(); FUN_0025b36c(); }
     * else { FUN_00356c3c(); FUN_0025a6a8(); }
     * return x21 < x19; */
    return false;
}
 ...
 * and (when the copy flag is clear) copies via FUN_0025b7d8; otherwise grows
 * via sibling FUN_0025a6a8 (copy-flag set) or FUN_0025b36c (clear).
...
void sk_set_resize_dispatch(long target, uint64_t copy_flag, void *p3)
{
     ...
     *   FUN_0025b7d8(p3); return; }
     * if (copy_flag&1) FUN_0025a6a8(target,p3); else FUN_0025b36c(target,p3); */
 ...
 * FUN_001afe4c(). Duplicate-element detection panic.
 * Confidence: high (pure fatal path)
 */
void sk_set_panic_dup(void)
{
    sk_vspace_fail(1);   /* FUN_003488bc(1) */
    sk_fatal_error(0, 0);   /* FUN_001afe4c noreturn */
}

/* FUN_0025baa4 @ 0x0025baa4   (est. sk_set_clear_range)
 * Ghidra: void FUN_0025baa4(long param_1)
...
void sk_set_clear_range(long set)
{
    ...
    sk_swift_alloc(0);   /* FUN_00354948 representative */
    (void)set;
}

/* FUN_0025badc @ 0x0025badc   (est. sk_set_clear_validated)
 ...
 */
void sk_set_clear_validated(long set, uint64_t p2, long size)
{
    /* if (param_1>=0 && !carry(FUN_003535f4()) &&
     *     FUN_00357e24(lo, size+0x38) bit0 && lo+0x24 == *(size+0x24))
     *   FUN_0022afd8(lo2, hi2, ~x8);
     * else { FUN_003488bc(1); FUN_0034a3ec(); FUN_001afe4c(); } */
    (void)set; (void)p2; (void)size;
    sk_vspace_fail(1);
}

/* FUN_0025bae0 @ 0x0025bae0   (est. sk_set_clear_validated2)
 ...
 * Confidence: low
 */
void sk_set_clear_validated2(long set, uint64_t p2, long size)
{
    (void)set; (void)p2; (void)size;
    sk_vspace_fail(1);
}
...
/* FUN_0025bb60 @ 0x0025bb60   (est. sk_set_scan_apply)
 ...
 */
void sk_set_scan_apply(void)
{
    /* FUN_0008e518(); auVar5=FUN_00352c34(); lVar3=hi;
     * FUN_00349720(); (*DAT_00658c00)(x8+0x40); auVar6=FUN_00348f50();
     * if (*(hi+0x10)!=0) {
     *   FUN_00350678(); FUN_0035056c(); (*x8_00)();
     *   lVar1=FUN_00354948(*(lVar3+0x20));
     *   while (uVar2=FUN_00359fa0(lVar1), bitmap bit unaff_x26 set) {
    ...
    sk_cpu();
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_0025bca4 @ 0x0025bca4   (est. sk_set_scan_apply16)
 * Ghidra: void FUN_0025bca4(void)
...
void sk_set_scan_apply16(void)
{
     ...
     * (*DAT_00658c00)(x8+0x40); FUN_00348f50();
     * if (*(x1+0x10)!=0) {
 ...
 *   stringify; noreturn FUN_001afe4c at the end.
 */
void sk_set_dup_panic(unsigned long msg)
{
     ...
     * loop until FUN_002a4b90 validates; FUN_001afe4c() noreturn. */
    (void)msg;
    sk_fatal_error(0, 0);   /* FUN_001afe4c noreturn */
}
 ...
 * path calls FUN_0025b36c (copy16) or FUN_0025a6a8 (copy8) with
 * extraout_x8+1; else FUN_0025b7d8 (copy8). Then FUN_0025af6c folds the
...
{
    /* FUN_00355760(); if (!CY || ZR) { if (flag&1==0) FUN_0025b36c(x8+1,p3);
     *   else FUN_0025a6a8(x8+1,p3); }
     * else if (flag&1==0) FUN_0025b7d8(p3);
 ...
 * (SoftwareBreakpoint 0x25c280); otherwise calls FUN_003591e0 (count bump).
 * Guard for the count increment.
 * Confidence: high (pure overflow guard)
 */
void sk_set_overflow_check(void)
{
    /* FUN_00356c90(); if (!OV) { FUN_003591e0(); return; }
     * SoftwareBreakpoint(1, 0x25c280); */
    SoftwareBreakpoint(1, 0x25c280);
}

/* FUN_0025c280 @ 0x0025c280   (est. sk_set_insert_slot)
 ...
 */
void sk_set_insert_slot(uint64_t elem, uint64_t slot, long set)
{
    long word = set + (slot >> 6) * 8;
    *(unsigned long *)(word + 0x38) |= 1UL << (slot & 0x3f);
    *(unsigned long *)(*(long *)(set + 0x30) + slot * 8) = elem;
    if (!SCARRY8(*(long *)(set + 0x10), 1)) {
        /* FUN_003591e0(*(set+0x10) + 1) */
        return;
    }
    SoftwareBreakpoint(1, 0x25c2b8);
}

/* FUN_0025c2b8 @ 0x0025c2b8   (est. sk_set_insert_slot_cb)
 * Ghidra: void FUN_0025c2b8(undefined8, ulong, long, long)
...
void sk_set_insert_slot_cb(uint64_t elem, uint64_t slot, long set, long desc)
{
    ...
    *(unsigned long *)(word + 0x38) |= 1UL << (slot & 0x3f);
    ...
    /* FUN_00359d58(); if (OV) SoftwareBreakpoint(1,0x25c33c); *(set+0x10)=x8; */
}

/* FUN_0025c33c @ 0x0025c33c   (est. sk_set_insert_keyed)
 ...
 * and probes for an existing matching element (sk_set_hash + linear scan with
 ...
 */
void sk_set_insert_keyed(uint64_t elem, uint64_t hash, uint64_t copy_flag)
{
    long set = (long)sk_self_reg();   /* *unaff_x20 */
    unsigned long count = *(unsigned long *)(set + 0x10);
    if (count < *(unsigned long *)(set + 0x18)) {
        if ((copy_flag & 1) == 0) {
            sk_set_copy16_rev();   /* FUN_0025b6d4 */
        }
    } else {
        /* grow via FUN_0025b294 (flag clear) or FUN_0025a5c4 (flag set) */
        uint64_t slot = sk_set_hash(*(unsigned long *)(set + 0x28), 0);   /* thunk_FUN_00229ebc */
        while ((slot = slot & ~(~0UL << (*(unsigned char *)(set + 0x20) & 0x3f))),
            ...
            if (*(long *)(*(long *)(set + 0x30) + slot * 8) == (long)elem) {
                sk_set_dup_panic(0x674278);
            }
            slot = slot + 1;
        }
    }
    sk_set_insert_slot(elem, 0, set);
}

/* FUN_0025c460 @ 0x0025c460   (est. sk_set_iterate_keyed)
 ...
 */
void sk_set_iterate_keyed(uint64_t p1, uint64_t p2, long set, uint64_t flag)
{
     ...
     *   seed; while (FUN_00359ec0(bitmap)) { FUN_00359704();
...
/* FUN_0025c570 @ 0x0025c570   (est. sk_set_union_apply8)
 * Ghidra: void FUN_0025c570(undefined8, undefined8, ulong)
...
void sk_set_union_apply8(uint64_t p1, uint64_t p2, uint64_t flag)
{
     ...
     * else if (flag&1==0) auVar8=FUN_0025b5e0();
     * FUN_000b4390(auVar8, *x20); FUN_0025c260(); FUN_00358454(x30); */
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_0025c754 @ 0x0025c754   (est. sk_set_union_apply16)
 * Ghidra: void FUN_0025c754(long, ulong, ulong)
...
/* FUN_0025c9a8 @ 0x0025c9a8   (est. sk_set_insert_keyed16)
 * Ghidra: void FUN_0025c9a8(long, ulong, ulong)
...
{
    long set = (long)sk_self_reg();
    unsigned long count = *(unsigned long *)(set + 0x10);
    if (count < *(unsigned long *)(set + 0x18)) {
        if ((flag & 1) == 0) sk_set_copy16_rev();   /* FUN_0025b6d4 */
    } else {
        uint64_t slot = sk_set_hash(*(unsigned long *)(set + 0x28), 0);
        while ((slot = slot & ~(~0UL << (*(unsigned char *)(set + 0x20) & 0x3f))),
               (*(unsigned long *)(set + 0x38 + (slot >> 6) * 8) >> (slot & 0x3f) & 1) != 0) {
            if (*(long *)(*(long *)(set + 0x30) + slot * 8) == (long)elem) {
                sk_set_dup_panic(0x677880);
            }
            slot = slot + 1;
        }
    }
 ...
 * FUN_0025b36c/FUN_0025a6a8, then walks the bitmap applying the descriptor
 * callback; a fold collision (uVar3&1) raises the dup panic. Completes via
 * FUN_0025c2b8 (insert with callback).
...
void sk_set_union_apply16b(uint64_t p1, uint64_t p2, uint64_t flag, long set)
{
     ...
     * (*DAT_00658c00)(x8+0x40); FUN_00348f38(); auVar8=FUN_00355760();
     * if (!CY||ZR) { if (flag&1==0) FUN_0025b36c(x8_00+1,set);
     *   else FUN_0025a6a8();
     ...
     * else if (flag&1==0) auVar8=FUN_0025b7d8(set);
     * FUN_00358e0c(auVar8, *x20); FUN_0025c2b8(); FUN_0008e500(); */
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_0025cc54 @ 0x0025cc54   (est. sk_set_insert_40)
 * Ghidra: void FUN_0025cc54(undefined8*, undefined8*, uint)
 * Inserts a 40-byte element into a set: probes for the slot (sk_set_hash +
 ...
 */
void sk_set_insert_40(uint64_t *out_elem, uint64_t *in_elem, uint32_t flag)
{
    long set = (long)sk_self_reg();
    uint64_t slot = sk_set_hash(*(unsigned long *)(set + 0x28), 0);
 ...
 * Completes via FUN_0025c2b8 insert-with-callback; returns {slot, found}.
 * Confidence: low (40-byte union fold)
 */
void sk_set_union_apply40(uint64_t p1, uint64_t p2, long set)
{
    (void)p1; (void)p2; (void)set;
    /* auVar11=FUN_0008e518(); uVar2=lo; uVar5=*(set+0x10);
     * FUN_003494e8(); (*DAT_00658c00)(x8+0x40); FUN_00348f50();
     ...
     *   FUN_0025bddc(uVar5); }
     * else { if (flag&1==0) auVar13=FUN_0025b7d8(set); if (uVar1) { swap; } }
     * FUN_00356254(auVar13, *x20); FUN_0025c2b8(); uVar5=1;
...
/* FUN_0025d3d0 @ 0x0025d3d0   (est. sk_set_elem_apply)
 ...
 */
void sk_set_elem_apply(uint64_t p1, long set)
{
    (void)p1; (void)set;
    /* lVar7=*(set+0x10); lVar6=*(lVar7-8); (*DAT_00658c00)(lVar6+0x40);
     ...
     *   if (bitmap bit clear) {
     *     if (count < capacity) { FUN_0025c2b8(local_68,uVar4,set,lVar7); return; }
     *     fatal: *(stk)=1; *(stk+8)=0x1e6; *(stk)=2;
     *       FUN_001afe4c("Fatal error", 0xb, 2, DAT_5be7c0, 0, 2,
    ...
    sk_fatal_error(0, 0x5d0100);   /* FUN_001afe4c("Swift NativeSet"...) */
}

/* FUN_0025d848 @ 0x0025d848   (est. sk_set_next_slot)
 ...
 */
void sk_set_next_slot(uint64_t out)
{
...
/* FUN_0025d8f4 @ 0x0025d8f4   (est. sk_set_next_apply)
 ...
 */
void sk_set_next_apply(void)
{
    /* FUN_00350a10(); FUN_0034e39c(); (*DAT_00658c00)();
     * auVar1=FUN_0034c8e0();
...
/* FUN_0025da00 @ 0x0025da00   (est. sk_set_elem_get)
 * Ghidra: undefined8 FUN_0025da00(long, long)
...
{
    (void)slot; (void)set;
    /* lVar3=*(set+0x10); lVar6=*(lVar3-8); (*DAT_00658c00)(lVar6+0x40);
...
/* FUN_0025db34 @ 0x0025db34   (est. sk_set_elem_move)
 * Ghidra: void FUN_0025db34(long, long, long)
 * Moves an element from slot param_1 to slot param_2 in a set: maps the
 * element (sk_elem_map / FUN_0019ce60) over the descriptor stride.
...
/* FUN_0025db98 @ 0x0025db98   (est. sk_set_remove_slot)
 * Ghidra: void FUN_0025db98(ulong)
...
void sk_set_remove_slot(uint64_t slot)
{
     ...
     *   uVar7 = sk_swift_string_hash() & uVar8;
     ...
     * if (!SBORROW8(count,1)) { count--; *(set+0x24)++; return; }
     * SoftwareBreakpoint(1, 0x25dd80); */
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_0025dd80 @ 0x0025dd80   (est. sk_set_remove_slot16)
 * Ghidra: void FUN_0025dd80(void)
...
void sk_set_remove_slot16(void)
{
     ...
     *     uVar5 = sk_swift_string_hash() & uVar7;
     ...
     * FUN_0034fa78(); if (!SBORROW8(count,1)) { count--; *(lVar8+0x24)++;
     *   FUN_000b45b0(hi); return; } SoftwareBreakpoint(1, 0x25dee4); */
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_0025dee4 @ 0x0025dee4   (est. sk_set_remove_slot40)
 * Ghidra: void FUN_0025dee4(void)
...
void sk_set_remove_slot40(void)
{
     ...
     * FUN_0034fa78(); if (!SBORROW8(count,1)) { count--; FUN_0035a224(count);
     *   FUN_000b45b0(hi); return; } SoftwareBreakpoint(1, 0x25e000); */
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_0025e000 @ 0x0025e000   (est. sk_set_remove_keyed)
 ...
 */
void sk_set_remove_keyed(void)
{
    /* FUN_0008e518(); FUN_00359ac8(); uVar10=*(x1+0x10); FUN_00349734();
     * (*DAT_00658c00)(x8+0x40); FUN_003493ac(); lVar7=*x20; lVar1=lVar7+0x38;
     ...
     * if (!SBORROW8(count,1)) { count--; *(lVar7+0x24)++; FUN_0008e500(); return; }
     * SoftwareBreakpoint(1, 0x25e1c8); */
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_0025e1c8 @ 0x0025e1c8   (est. sk_set_remove_dispatch)
 * Ghidra: void FUN_0025e1c8(undefined8, undefined8, long)
 * Remove dispatch: on the stable path copies via FUN_0025b7d8 (copy8), invokes
...
{
    (void)p1; (void)p2; (void)set;
    /* FUN_003515f0(); if (flag&1==0) FUN_0025b7d8(set);
...
/* FUN_0025e240 @ 0x0025e240   (est. sk_set_realloc)
 * Ghidra: void FUN_0025e240(ulong, long)
 * Reallocates the set storage: if param_1&1 is clear, allocates a fresh set of
 * the given size/seed (FUN_0025e5d0) and stores it back; otherwise it walks
 ...
 */
void sk_set_realloc(uint64_t flag, long set)
{
    (void)flag; (void)set;
    /* lVar5=*x20; if (flag&1==0) { uVar2=*(lVar5+0x20);
     *   lVar5=FUN_0031d3a4(0, *(set+0x10), *(set+0x18)); FUN_0034c988(uVar2);
     *   FUN_0025e5d0(); FUN_00351d18(); FUN_0036b118(); *x20=lVar5; return; }
...
/* FUN_0025e370 @ 0x0025e370   (est. sk_set_alloc)
 * Ghidra: ulong FUN_0025e370(undefined8, ulong, ulong, char)
 ...
 */
uint64_t sk_set_alloc(uint64_t log2_slots, uint64_t seed, uint64_t seed2, char flag)
{
    uint64_t nbits = 1UL << (log2_slots & 0x3f);
    uint64_t nwords = (nbits + 0x3f) >> 6;
    unsigned long desc = sk_object_lock(0, 0, 0, 0, 0);   /* FUN_00002534(&LAB_006576b0,...) */
    uint64_t base = sk_swift_alloc_buf((nwords * 8 + 0x3f & 0x3ffffffffffffff8) +
                                       (0x28UL << (log2_slots & 0x3f)), 7);   /* FUN_0036a940 */
    long *pl = (long *)(base + 0x38);
    *(unsigned long *)(base + 0x10) = 0;
    *(unsigned long *)(base + 0x18) = sk_set_capacity(log2_slots);   /* capacity */
    ...
    *(unsigned short *)(base + 0x22) = 0;
    if ((seed & 0xff00000000) == 0x100000000) {
        seed = sk_set_hash(0, base);   /* thunk_FUN_00229ebc */
    }
    *(unsigned int *)(base + 0x24) = (unsigned int)seed;
    /* DAT_006adf20 (global string-flag) == 0 -> use base */
    ...
    *(long **)(base + 0x30) = pl + nwords;
    if ((long)nbits < 0x40) {
        *pl = ~0UL << (nbits & 0x3f);
        ...
        sk_set_alloc_fill(0, nwords, (unsigned long)pl);   /* zero bitmap, FUN_001b5474 */
    }
    return base;
}

/* FUN_0025e4a0 @ 0x0025e4a0   (est. sk_set_alloc16)
 * Ghidra: void FUN_0025e4a0(void)
 ...
 * direct, else FUN_001b5474). Companion to sk_set_alloc for 16-byte strides.
...
void sk_set_alloc16(void)
{
     ...
     * FUN_00359368(); FUN_00350d54(); if (ZR) { FUN_00350488(); sk_set_hash(); }
...
/* FUN_0025e538 @ 0x0025e538   (est. sk_set_alloc8b)
 * Ghidra: void FUN_0025e538(void)
...
/* FUN_0025e5d0 @ 0x0025e5d0   (est. sk_set_alloc_seeded)
 * Ghidra: void FUN_0025e5d0(undefined8, undefined8, undefined8)
...
void sk_set_alloc_seeded(uint64_t p1, uint64_t p2, uint64_t p3)
{
     ...
     * FUN_00350d54(); if (ZR) { FUN_00350488(); sk_set_hash(); }
...
/* FUN_0025e73c @ 0x0025e73c   (est. sk_set_next_slot2)
 ...
 */
void sk_set_next_slot2(uint64_t out, long set)
{
    (void)out; (void)set;
...
/* FUN_0025e85c @ 0x0025e85c   (est. sk_set_filter_40)
 ...
 */
void sk_set_filter_40(int8_t *out_found, long dst_bitmap, uint64_t p3, uint64_t p4,
                      long src_set, long seq, long set, uint64_t p8, uint64_t p9)
{
    ...
    /* lVar11=*(seq-8); local_d0=out_found; (*DAT_00658c00)(lVar11+0x40);
     * lVar20 = alloc; (*DAT_00658c00)(); lVar12=lVar20-x12;
...
/* FUN_0025ecb8 @ 0x0025ecb8   (est. sk_set_filter_40b)
 * Ghidra: void FUN_0025ecb8(undefined8, long, undefined8, undefined8, long,
                       ...
                       long src_set, long seq, long set, uint64_t p8, uint64_t p9)
{
    (void)out_found; (void)dst_bitmap; (void)p3; (void)p4; (void)src_set;
    (void)seq; (void)set; (void)p8; (void)p9;
    /* lVar13=*(seq-8); local_e0=out_found; (*DAT_00658c00)(lVar13+0x40);
...
/* FUN_0025f164 @ 0x0025f164   (est. sk_set_filter_alloc)
 * Ghidra: void FUN_0025f164(undefined8, undefined8, undefined8, undefined8,
 *         undefined8, undefined8, undefined8, code*)
 * Filter-closure allocator: builds a filter context (local_78) seeded from the
 * log2 stride (bit-0xd fast path vs FUN_003d31f8 slow path), runs the
                         ...
                         uint64_t p5, uint64_t p6, uint64_t p7, void (*cb)(void))
{
     ...
     * local_8=x8_00;
     * if (bVar6<0xe || FUN_003d31f8(lVar7,8)&1) { (*DAT_00658c00)();
     ...
     *     FUN_003698b0(local_78,uVar5,0x66c1c8); SoftwareBreakpoint(1,0x25f2e4); } }
...
/* FUN_0025f2e4 @ 0x0025f2e4   (est. sk_set_filter_fold)
 ...
 * element was added. Same sequence-engine shape as sk_set_filter_40.
 * Confidence: low (filter-fold)
 */
void sk_set_filter_fold(int8_t *out_found, long dst_bitmap, uint64_t p3, uint64_t p4,
                        long src_set, long seq, long set, uint64_t p8, uint64_t p9)
{
    (void)out_found; (void)dst_bitmap; (void)p3; (void)p4; (void)src_set;
    (void)seq; (void)set; (void)p8; (void)p9;
    /* lVar10=*(seq-8); local_c0=p2; local_b0=out_found; (*DAT_00658c00)(lVar10+0x40);
...
/* FUN_0025f754 @ 0x0025f754   (est. sk_set_filter_keep)
 ...
 */
uint64_t *sk_set_filter_keep(uint64_t *src_bitmap, long count, long stride, uint64_t *src_set,
                             long seq, uint64_t p6)
{
    (void)src_set; (void)seq; (void)p6;
    /* lVar5=*(seq-8); lVar4=stride; local_68=p6; (*DAT_00658c00)(lVar5+0x40);
     * lVar8=alloc;
     * if (stride==0) { FUN_0036b118(src_set); return &DAT_006577e0; }
...
/* FUN_0025f910 @ 0x0025f910   (est. sk_set_filter_transform)
 * Ghidra: undefined8* FUN_0025f910(undefined8, undefined8*, long, long,
                                  ...
                                  uint64_t p5, uint64_t p6)
{
     ...
     * (*DAT_00658c00)(local_108+0x40...); lVar10=*(src-8); local_c8=alloc;
     * (*DAT_00658c00)(lVar10+0x40); lVar14=...; (*DAT_00658c00)();
     * lVar11=*(seq-8); local_a0=lVar14-x12; (*DAT_00658c00)(lVar11+0x40);
     * lVar12=(lVar14-x12)-(x8_01+mask); local_b8=FUN_00377824(...);
     * (*DAT_00658c00)(local_b8-8+0x40...); lVar15=lVar12-x8_02;
     * if (dst[2]==0) { FUN_0036b118(dst); dst=&DAT_006577e0; }
...
/* FUN_0026001c @ 0x0026001c   (est. sk_set_filter_drop)
 * Ghidra: void FUN_0026001c(undefined8*, long, undefined8, long, ulong,
                        ...
                        uint64_t p10)
{
     ...
     * local_f0=*(lStack_e8-8); (*DAT_00658c00)(local_f0+0x40...);
     * lVar16=&local_f0-x8; lVar11=*(seq-8); (*DAT_00658c00)(lVar11+0x40);
     * lVar14=lVar16-(x8_00+mask); (*DAT_00658c00)(); lVar12=lVar14-x12;
     ...
     * } while (local_c8!=0);
     * puVar10=&DAT_006577e0;
     * fin: *out_dst=puVar10; */
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_002603f8 @ 0x002603f8   (est. sk_set_filter_make)
 * Ghidra: void FUN_002603f8(undefined8, undefined8, long, undefined8, undefined8)
...
void sk_set_filter_make(uint64_t p1, uint64_t p2, long src_set, uint64_t p4, uint64_t p5)
{
     ...
     * if (log2<0xe || FUN_003d31f8(lVar7,8)&1) { (*DAT_00658c00)();
...
/* FUN_00260690 @ 0x00260690   (est. sk_set_filter_apply)
 ...
 */
void sk_set_filter_apply(uint64_t *out_dst, long dst_bitmap, uint64_t p3, long src_set,
                         void (*pred)(void *), uint64_t p6, long seq, uint64_t p8)
{
     ...
     * local_70=seq; (*DAT_00658c00)(*(seq-8)+0x40); local_90=alloc;
     ...
     *   else { take lowbit; } uVar9=sk_lowbit_idx(uVar12,lVar10);
...
/* FUN_002608cc @ 0x002608cc   (est. sk_set_filter_make16)
 * Ghidra: void FUN_002608cc(undefined8, long, undefined8, undefined8)
...
/* FUN_00260b44 @ 0x00260b44   (est. sk_set_merge_filter)
 ...
 */
void sk_set_merge_filter(uint64_t *out_dst, long dst_bitmap, uint64_t p3, long dst_set,
                         long src_set, long seq, uint64_t p7)
{
     ...
     * (*DAT_00658c00)(lVar7+0x40); puVar8=alloc; (*DAT_00658c00)();
     * lVar16=puVar8-x12; (*DAT_00658c00)(); lVar9=lVar16-x12_00; (*DAT_00658c00)();
     * lVar18=dst_set;
     ...
     *     uVar17=sk_lowbit_idx; lVar13=*(lVar7+0x48); pcVar11=*(lVar7+0x10);
     ...
     *     uVar10=sk_lowbit_idx; lVar12=*(lVar7+0x48); pcVar11=*(lVar7+0x10);
...
/* FUN_00261134 @ 0x00261134   (est. sk_set_filter_make40)
 * Ghidra: void FUN_00261134(undefined8, long, undefined8, undefined8, undefined8,
 *         undefined8)
...
/* FUN_002613b4 @ 0x002613b4   (est. sk_set_filter_keep16)
 * Ghidra: void FUN_002613b4(undefined8*, long, undefined8, undefined8, long,
 *         long, long, undefined8, undefined8)
                          ...
                          long src_set, long seq, long set, uint64_t p8, uint64_t p9)
{
    ...
    (void)seq; (void)set; (void)p8; (void)p9;
    /* lVar12=*(seq-8); local_e0=p3; local_d8=out_dst; (*DAT_00658c00)(lVar12+0x40);
     * puVar14=alloc; (*DAT_00658c00)(); lVar13=puVar14-x12;
...
/* FUN_0026181c @ 0x0026181c   (est. sk_set_string_prepare)
 * Ghidra: void FUN_0026181c(undefined8, undefined8, undefined8, undefined8)
...
/* FUN_002618e8 @ 0x002618e8   (est. sk_set_string_prepare_a)
 * Ghidra: void FUN_002618e8(void)
...
void sk_set_string_prepare_a(void)
{
     ...
     * (*DAT_00658c00)(); FUN_0034aee4(); FUN_0007b384(); FUN_00350b24();
...
/* FUN_002619b0 @ 0x002619b0   (est. sk_set_string_prepare_b)
 * Ghidra: void FUN_002619b0(void)
...
/* FUN_00261a7c @ 0x00261a7c   (est. sk_set_result_zero)
 ...
 */
void sk_set_result_zero(uint64_t *out, uint64_t p2)
{
...
/* FUN_00261ac8 @ 0x00261ac8   (est. sk_set_string_init)
 * Ghidra: void FUN_00261ac8(undefined8, undefined8, undefined8, undefined8)
 * String/set initializer: seeds the object (x21) with the type descriptor
 * (FUN_0031d3bc + DAT_004f17a8 method table), then invokes the descriptor
...
void sk_set_string_init(uint64_t p1, uint64_t p2, uint64_t p3, uint64_t p4)
{
     ...
     * *(x21+0x20)=&DAT_004f17a8; FUN_00319a4c(); FUN_0034b3e8();
     * (**(x16+0x20))(); */
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_00261b48 @ 0x00261b48   (est. sk_set_string_dispatch)
 * Ghidra: void FUN_00261b48(void)
 ...
 * FUN_00261c88 @ 0x00261c88   (est. sk_set_panic_b)
 * FUN_00261cd0 @ 0x00261cd0   (est. sk_set_panic_c)
 * FUN_00261d18 @ 0x00261d18   (est. sk_set_panic_d)
 * Ghidra: void FUN_00261c40(void)  (each)
 * Identical noreturn panics: FUN_003488bc(1); FUN_0006f768(); noreturn
 * FUN_00356408(). Four aliases for distinct set-fatal conditions.
 * Confidence: high (pure fatal path)
 */
void sk_set_panic_a(void) { sk_vspace_fail(1); sk_fatal_error(0, 0); }
void sk_set_panic_b(void) { sk_vspace_fail(1); sk_fatal_error(0, 0); }
void sk_set_panic_c(void) { sk_vspace_fail(1); sk_fatal_error(0, 0); }
void sk_set_panic_d(void) { sk_vspace_fail(1); sk_fatal_error(0, 0); }

/* FUN_00261d60 @ 0x00261d60   (est. sk_set_string_member)
 ...
 */
void sk_set_string_member(long obj, long src)
{
...
/* FUN_00261db0 @ 0x00261db0   (est. sk_set_string_iterate)
 * Ghidra: void FUN_00261db0(void)
...
void sk_set_string_iterate(void)
{
     ...
     * (*DAT_00658c00)(); FUN_0034af20(); FUN_003504e8(); FUN_00310d68();
     * FUN_00348d7c(); (*DAT_00658c00)(x8_00+0x40); FUN_003489c0();
     * (*DAT_00658c00)(); FUN_0034c074(); FUN_0034998c();
     * (*DAT_00658c00)(x8_01+0x40); FUN_00348f38();
...
/* FUN_00261f98 @ 0x00261f98   (est. sk_set_string_dispatch2)
 * Ghidra: void FUN_00261f98(void)
...
void sk_set_string_dispatch2(void)
{
     ...
     * (*DAT_00658c00)(); FUN_0034b71c(); FUN_003504e8(); FUN_00310d68();
     * FUN_000a6f88(); (*DAT_00658c00)(x8+0x40); FUN_00348abc();
     * (*DAT_00658c00)(); FUN_0034b87c(); FUN_0034998c();
     * (*DAT_00658c00)(x8_00+0x40); FUN_0034947c(); FUN_003494e8();
     * (*DAT_00658c00)(x8_01+0x40); FUN_003503ec(); (*DAT_00658c00)();
...
/* FUN_00262234 @ 0x00262234   (est. sk_set_dispatch_chain1)
 * FUN_00262238 @ 0x00262238   (est. sk_set_dispatch_chain1b)
 * FUN_00262248 @ 0x00262248   (est. sk_set_dispatch_chain2)
 * FUN_00262258 @ 0x00262258   (est. sk_set_dispatch_chain3)
 * FUN_00262268 @ 0x00262268   (est. sk_set_dispatch_chain4)
 * Ghidra: void FUN_00262234(undefined8, undefined8, undefined8)  (each)
 * Dispatch chains that run N panic guards (FUN_00261c40/00261c88/00261cd0/
 * 00261d18) and then the iterate helper FUN_00261db0(p3, guard). Progressively
...
{
    (void)p1; (void)p2; (void)p3;
    sk_set_panic_a(); sk_set_panic_b(); sk_set_panic_c();
    sk_set_panic_d();
    sk_set_string_iterate();   /* FUN_00261db0 */
}
void sk_set_dispatch_chain1b(uint64_t p1, uint64_t p2, uint64_t p3)
{
    (void)p1; (void)p2; (void)p3;
    sk_set_panic_a(); sk_set_panic_b(); sk_set_panic_c();
    sk_set_panic_d();
...
void sk_set_dispatch_chain2(uint64_t p1, uint64_t p2, uint64_t p3)
{
    (void)p1; (void)p2; (void)p3;
    sk_set_panic_b(); sk_set_panic_c(); sk_set_panic_d();
    sk_set_string_iterate();
}
void sk_set_dispatch_chain3(uint64_t p1, uint64_t p2, uint64_t p3)
{
    (void)p1; (void)p2; (void)p3;
    sk_set_panic_c(); sk_set_panic_d();
    sk_set_string_iterate();
}
void sk_set_dispatch_chain4(uint64_t p1, uint64_t p2, uint64_t p3)
{
    (void)p1; (void)p2; (void)p3;
    sk_set_panic_d();
    sk_set_string_iterate();
...
/* FUN_00262290 @ 0x00262290   (est. sk_set_string_prepare_c)
 * Ghidra: void FUN_00262290(undefined8, undefined8, undefined8)
...
/* FUN_0026235c @ 0x0026235c   (est. sk_set_string_lookup)
 * Ghidra: void FUN_0026235c(void)
...
void sk_set_string_lookup(void)
{
     ...
     * FUN_0007c1a4(); (*DAT_00658c00)(); FUN_0034b0c4(); FUN_00350bd8(x3);
     * FUN_003560f8(); FUN_00377824(); FUN_00350798(); FUN_00310d68();
     * FUN_00348cd0(); FUN_0007c1a4(); (*DAT_00658c00)(); FUN_0034bdfc();
...
/* FUN_002624f0 @ 0x002624f0   (est. sk_set_string_lookup2)
 * Ghidra: void FUN_002624f0(void)
...
/* FUN_00262690 @ 0x00262690   (est. sk_set_string_hash_run)
 * Ghidra: void FUN_00262690(undefined8, undefined8, undefined8)
...
void sk_set_string_hash_run(uint64_t p1, uint64_t p2, uint64_t p3)
{
     ...
     * (*DAT_00658c00)(); FUN_0034b05c(); FUN_00350630(*(x12+0x10));
 ...
 * (FUN_003489dc(0x95); noreturn FUN_0034a2f8()).
...
void sk_set_string_validate(uint64_t p1, uint64_t p2, uint64_t p3, uint64_t p4)
{
     ...
     * (*DAT_00658c00)(); FUN_0034aee4(); FUN_003504e8(); FUN_0034d464();
     * FUN_0007c1a4(); (*DAT_00658c00)(); FUN_0034b0c4(); FUN_0031d428(p4);
     ...
     * FUN_003489dc(0x95); FUN_0034a2f8(); FUN_001afe4c(); */
    sk_fatal_error(0x95, 0);
}
...
/* FUN_00262888 @ 0x00262888   (est. sk_string_unicode_scan)
 * Ghidra: undefined8 FUN_00262888(void)
...
/* FUN_002628d0 @ 0x002628d0   (est. sk_string_unicode_next)
 * Ghidra: void FUN_002628d0(void)
...
/* FUN_00262950 @ 0x00262950   (est. sk_string_unicode_char)
 * Ghidra: void FUN_00262950(void)
...
void sk_string_unicode_char(void)
{
     ...
     * FUN_00348e18(); FUN_0007c1a4(); (*DAT_00658c00)(); FUN_0034b05c();
...
/* FUN_00262a4c @ 0x00262a4c   (est. sk_string_unicode_append)
 ...
 */
void sk_string_unicode_append(uint64_t p1, uint64_t p2, uint64_t p3)
{
    (void)p1; (void)p2; (void)p3;
    /* FUN_00351a80(); FUN_0034d464(0); FUN_0007c1a4(); (*DAT_00658c00)();
     * FUN_0034cff4();
     ...
     * FUN_00348b40(); FUN_0034a2f8(); FUN_001afe4c(); */
    sk_fatal_error(0, 0);
}

/* FUN_00262b5c @ 0x00262b5c   (est. sk_string_scalar_run)
 * Ghidra: void FUN_00262b5c(undefined8)
...
void sk_string_scalar_run(uint64_t p1)
{
     ...
     * (*DAT_00658c00)(); FUN_0034b0c4(); FUN_003506b0(); FUN_0034c2a4();
     * (*x9)(); FUN_00077708(p1); (*in_x3)(); */
    (void)p1;
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_00262bf0 @ 0x00262bf0   (est. sk_string_unicode_init)
 * Ghidra: void FUN_00262bf0(void)
 ...
 * string header (type descriptor DAT_00657778, capacity 0x1000000000000, flags).
...
void sk_string_unicode_init(void)
{
     ...
     * FUN_00348abc(); (*DAT_00658c00)(); FUN_0034b87c();
     ...
     * store: *(lVar2+8)=uVar3; *(lVar2+0x10)=&DAT_00657778; *(lVar2+0x18)=0;
     *   *(lVar2+0x1c)=0x1000000000000; *(lVar2+0x28)=&DAT_00657778;
...
/* FUN_00262da4 @ 0x00262da4   (est. sk_string_next_scalar)
 * Ghidra: ulong FUN_00262da4(long)
 * Next Unicode scalar from a Swift String: reads the string object (param_1)
 * and iterates its UTF-8 buffer via the grapheme scanner (FUN_00263e20 with
 * callback LAB_00343190, or FUN_00263068 fast path). Handles the "pending
 * scalar" state (+0x34/+0x38) and Hangul composition (FUN_002641a8). Returns
...
/* FUN_00262e9c @ 0x00262e9c   (est. sk_string_utf8_decode)
 * Ghidra: void FUN_00262e9c(void)
...
/* FUN_00263068 @ 0x00263068   (est. sk_string_utf8_fast)
 * Ghidra: void FUN_00263068(void)
...
/* FUN_002630fc @ 0x002630fc   (est. sk_string_scalar_done)
 * Ghidra: void FUN_002630fc(void)
 * Scalar-done: FUN_00262da4() then FUN_00351fc0(). Advances the scalar state
 * and commits.
...
/* FUN_00263124 @ 0x00263124   (est. sk_string_scalar_run2)
 * FUN_00263128 @ 0x00263128   (est. sk_string_scalar_run3)
 * Ghidra: void FUN_00263124(void)  (each)
 * Scalar run: FUN_003555dc() then FUN_00262b5c(). Two thin wrappers.
 * Confidence: low
 */
void sk_string_scalar_run2(void) { sk_string_scalar_run(0); }
void sk_string_scalar_run3(void) { sk_string_scalar_run(0); }

/* FUN_00263140 @ 0x00263140   (est. sk_string_scalar)
 ...
 */
uint64_t sk_string_scalar(char *str, uint64_t p2)
{
    (void)str; (void)p2;
     ...
     *       if ((uVar2&1)==0) { lVar4=sk_swift_string_buf_grow(0,*(lVar4+0x10)+1,1,lVar4);
     *         *(str+8)=lVar4; }
     ...
     *     done: while (true) { uVar5=FUN_00262e9c(p2);
     ...
     *       str[0x1a]=0; FUN_0026448c(); str[0x1b]=1; *str=0;
     *       uVar5=FUN_002641a8(); uVar2=uVar5&0x1000000000000; goto out; }
     *       if ((uVar3&1)==0) { uVar2=0; str[0x18..0x17]=0; str[0x1a]=1;
     *         uVar5=uVar5&0xffffffff | uVar3<<0x20; goto out; }
     *     hangul: if ((uVar5-0xac00>>2)<0xae9) FUN_00264558(); else FUN_002646a0(uVar5,uVar3);
...
/* FUN_00263360 @ 0x00263360   (est. sk_string_scalar2)
 * Ghidra: ulong FUN_00263360(char*, undefined8*)
 * Second scalar reader: same structure as sk_string_scalar but reads from the
...
{
    (void)str; (void)desc;
    /* same shape as sk_string_scalar but reads scalar from desc[4] index /
     * desc[0..3] buffer; 4-byte UTF-8 decode; FUN_0026448c()/FUN_00264558()/
     * FUN_002646a0() Hangul. */
    return 0;
}

/* FUN_00263784 @ 0x00263784   (est. sk_string_unicode_reader)
 * Ghidra: void FUN_00263784(void)
...
void sk_string_unicode_reader(void)
{
     ...
     *       if ((uVar6&1)==0) { FUN_0006b3f4(*(lVar8+0x10)); lVar8=sk_swift_string_buf_grow();
     *         *(x20+8)=lVar8; }
     ...
     *       x20[0x1a]=0; FUN_0026448c(); x20[0x1b]=1; *x20=0;
     *       uVar9=FUN_002641a8(); uVar6=uVar9&0x1000000000000; goto out; }
     *       if ((uVar7&1)==0) { uVar6=0; x20[0x18..0x17]=0; x20[0x1a]=1;
     *         uVar9=uVar9&0xffffffff | uVar7<<0x20; goto out; }
     *     hangul: if ((uVar9-0xac00>>2)<0xae9) FUN_00264558(); else FUN_002646a0(uVar9,uVar7); }
...
/* FUN_0026398c @ 0x0026398c   (est. sk_string_scalar_reader)
 * Ghidra: ulong FUN_0026398c(char*)
 * Scalar reader (buffer variant): reads scalars into the grapheme buffer
 * (param_1+0x28) from the decoder FUN_00264068, handling the pending-scalar
 * state (+0x34/+0x38) and Korean composition (FUN_002641f8). Returns
...
uint64_t sk_string_scalar_reader(char *str)
{
     ...
     *   str[0x30]=0; *str=1; }
     * while (uVar2=FUN_00264068(), (uVar2&0xff000000000000)!=0x1000000000000) {
     ...
     *       uVar4=FUN_002641f8(uVar1,uVar2); if (uVar4>>0x20!=0 && FUN_003d35f0()==-1)
     *       goto append; store; }
...
/* FUN_00263bcc @ 0x00263bcc   (est. sk_string_scalar_reader2)
 * Ghidra: ulong FUN_00263bcc(char*, undefined8)
...
/* FUN_00263e20 @ 0x00263e20   (est. sk_string_scalar_reader3)
 * Ghidra: ulong FUN_00263e20(char*, undefined8, undefined8)
 * Scalar reader (third variant): same state machine but pulls scalars from
 * FUN_00263784(p2, p3). Faithful reader with Hangul composition.
 * Confidence: medium (faithful reader)
 */
uint64_t sk_string_scalar_reader3(char *str, uint64_t p2, uint64_t p3)
{
    (void)str; (void)p2; (void)p3;
    /* while (uVar2=FUN_00263784(p2,p3), uVar2>>0x30==0) { same state machine } */
    return 0;
}

/* FUN_00264068 @ 0x00264068   (est. sk_string_scalar_emit)
 * Ghidra: ulong FUN_00264068(void)
...
uint64_t sk_string_scalar_emit(void)
{
     ...
     *     do { if (*(lVar6+0x10)<=uVar3) { FUN_00348304(); FUN_001afe4c(); }
...
/* FUN_002641a8 @ 0x002641a8   (est. sk_string_pending_scalar)
 * Ghidra: ulong FUN_002641a8(void)
...
/* FUN_002641f8 @ 0x002641f8   (est. sk_hangul_compose)
 * Ghidra: ulong FUN_002641f8(int, int)
 ...
 * String fatal: FUN_00348404(1); FUN_00351be0(); noreturn FUN_001afe4c().
 * Confidence: high (pure fatal path)
 */
void sk_string_panic_e(void)
{
    sk_vspace_fail(1);   /* FUN_00348404(1) */
    sk_fatal_error(0, 0);   /* FUN_001afe4c */
}

/* FUN_002642bc @ 0x002642bc   (est. sk_string_init_obj)
 * Ghidra: void FUN_002642bc(undefined8, undefined8, undefined8)
 ...
 * header (*x8_00=1, +8=&DAT_00657778, +0x10=0, +0x14=0x1000000000000).
 * Faithful string-object construction.
...
void sk_string_init_obj(uint64_t p1, uint64_t p2, uint64_t p3)
{
     ...
     * FUN_0035a738(); *x8_00=1; *(x8_00+8)=&DAT_00657778; x8_00[0x10]=0;
     * *(x8_00+0x14)=0x1000000000000; */
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_00264344 @ 0x00264344   (est. sk_string_next_grapheme)
 * Ghidra: ulong FUN_00264344(long)
 * Next grapheme cluster: reads the pending scalar (FUN_002643f4); if none is
 * pending, emits the next scalar (FUN_00264068) and composes it. Returns the
 * grapheme or the EOL marker. Faithful grapheme iterator.
 * Confidence: medium (faithful grapheme iterator)
 */
uint64_t sk_string_next_grapheme(long str)
{
    (void)str;
    /* uVar1=*(str+0x18); FUN_0034bd80(); FUN_003510c4(); FUN_00377824();
     * FUN_00356774(); FUN_003513a8(uVar1); auVar5=FUN_00377bec();
     * FUN_00084174(auVar5); uVar3=FUN_002643f4();
     * if (uVar3>>0x20==0) uVar4=uVar3&0x100000000;
     * else { uVar4=FUN_00264068(); bVar2=(uVar4&0xff000000000000)!=0x1000000000000;
     *   uVar3=0; if (bVar2) uVar3=uVar4; uVar4=0x100000000; if (bVar2) uVar4=0; }
     * return uVar4|uVar3&0xffffffff; */
    return 0;
}

/* FUN_002643f4 @ 0x002643f4   (est. sk_string_pending_grapheme)
 * Ghidra: ulong FUN_002643f4(void)
 * Pending-grapheme accessor: reads via FUN_00354d44/FUN_00263784 and returns
 * {scalar, valid} with the EOL check.
 * Confidence: low (opaque accessor)
 */
uint64_t sk_string_pending_grapheme(void)
{
    /* FUN_00354d44(); uVar2=FUN_00263784(); uVar1=uVar2;
     * if (0xffffffffffff < uVar2) uVar1=0;
     * return uVar1&0xffffffff | (uVar2>>0x30&1)<<0x20; */
    return 0;
}

/* FUN_00264448 @ 0x00264448   (est. sk_string_grapheme_done)
 * Ghidra: void FUN_00264448(void)
 * Grapheme-done: FUN_00264344() then FUN_00351fc0(). Advances + commits.
 * Confidence: low (thin wrapper)
 */
void sk_string_grapheme_done(void)
{
    sk_string_next_grapheme(0);
    sk_thread_epilogue(0, 0, 0);
}

/* FUN_00264470 @ 0x00264470   (est. sk_string_run_a)
 * FUN_00264474 @ 0x00264474   (est. sk_string_run_b)
 * Ghidra: void FUN_00264470(void)  (each)
 * String run: FUN_003555b4() then FUN_00262b5c(). Two thin wrappers.
 * Confidence: low
 */
void sk_string_run_a(void) { sk_string_scalar_run(0); }
void sk_string_run_b(void) { sk_string_scalar_run(0); }

/* FUN_0026448c @ 0x0026448c   (est. sk_string_buffer_commit)
 * Ghidra: void FUN_0026448c(void)
...
void sk_string_buffer_commit(void)
{
     ...
     *   *x20=lVar4; uVar2=1;
     *   do { if (*(lVar4+0x10)<=uVar2) { FUN_00348304(); FUN_001afe4c(); }
...
/* FUN_00264558 @ 0x00264558   (est. sk_hangul_decompose_append)
 * Ghidra: void FUN_00264558(void)
...
void sk_hangul_decompose_append(void)
{
     ...
     * FUN_001a157c(sk_swift_string_buf_grow); lVar6=*(*(x20+8)+0x10);
     * FUN_001a1648(lVar6, sk_swift_string_buf_grow);
...
/* FUN_002646a0 @ 0x002646a0   (est. sk_string_utf8_append)
 * Ghidra: void FUN_002646a0(void)
...
void sk_string_utf8_append(void)
{
     ...
     *     else width=1;
     *     if (uVar9 < width) { FUN_00347d60(); FUN_001afe4c(); }
     *     uVar9 -= width;
 ...
 * String fatal: FUN_00348074(1); FUN_00351be0(); noreturn FUN_001afe4c().
 * Confidence: high (pure fatal path)
 */
void sk_string_panic_f(void)
{
    sk_vspace_fail(1);   /* FUN_00348074(1) */
    sk_fatal_error(0, 0);   /* FUN_001afe4c */
}

/* FUN_00264914 @ 0x00264914   (est. sk_string_tag_low)
 * FUN_00264934 @ 0x00264934   (est. sk_string_tag_low2)
 * Ghidra: uint FUN_00264914(void)  (each)
...
{
    uint32_t base = (uint32_t)sk_object_lock(0, 0, 0, 0, 0);   /* FUN_0034cec4 */
    return base & 0xffffffc0 | 0;   /* | extraout_w8 & 0x3f */
}
uint32_t sk_string_tag_low2(void)
{
    uint32_t base = (uint32_t)sk_object_lock(0, 0, 0, 0, 0);   /* FUN_0034a018 */
    return base & 0xffffffc0 | 0;   /* | extraout_w8 & 0x3f */
}

/* FUN_00264954 @ 0x00264954   (est. sk_string_tag_merge)
 * Ghidra: uint FUN_00264954(void)
...
{
    uint32_t base = (uint32_t)sk_object_lock(0, 0, 0, 0, 0);   /* FUN_00353ff4 */
    return (base & 0x1f) << 6 | 0;   /* | extraout_w8 & 0xfffff800 | ... & 0x3f */
}

/* FUN_00264b90 @ 0x00264b90   (est. sk_string_unicode_verify)
 ...
 */
void sk_string_unicode_verify(void)
{
    /* pcVar1=FUN_00353cfc(); FUN_003499c8(); (*DAT_00658c00)(x8_00+0x40);
     * FUN_003493ac(); FUN_00349720(); (*DAT_00658c00)(x8_01+0x40);
...
/* FUN_00264ccc @ 0x00264ccc   (est. sk_string_unicode_verify2)
 ...
 */
void sk_string_unicode_verify2(void)
{
    /* FUN_00353cfc(); FUN_003561a0(); FUN_003499f0(); (*DAT_00658c00)(x8+0x40);
     * FUN_003493ac(); FUN_00349720(); (*DAT_00658c00)(x8_00+0x40);
...
/* FUN_00264df8 @ 0x00264df8   (est. sk_string_optional_build)
 ...
 * buffer FUN_0036a9a0 with the type descriptor DAT_004baeb0), else returns the
 ...
 * Notes: string at 0x5d0212 ("Optional"); type descriptor DAT_004baeb0.
 */
void sk_string_optional_build(void)
{
    /* auVar5=FUN_0008e518(); uVar3=lo; FUN_000a6f88();
     * (*DAT_00658c00)(x8+0x40); FUN_000aa4ec(); FUN_0035196c();
     ...
     * uVar1=DAT_004baeb0; *(lVar2+0x18)=uRam_4baeb8; *(lVar2+0x10)=uVar1;
     * *(lVar2+0x38)=lVar4; FUN_00319a4c(lVar2+0x20); FUN_0034b3c8();
     * (**(x16+0x20))(); FUN_003509f8(&DAT_005be7c0); FUN_001a89a8();
     * FUN_00352c80(); FUN_0034f030(); FUN_003509f8(&DAT_005be7c0); FUN_001a89a8();
     * FUN_00357b3c(); FUN_00319808(lVar2+0x20, auStack_70);
     * FUN_00310d98(auStack_70, auStack_90); FUN_0034b824(x24&mask);
     * if (ok) { FUN_003a25d4(uVar3); puVar7=&DAT_005be7c0; }
     * else { validate; ... }
...
/* FUN_00265138 @ 0x00265138   (est. sk_string_error_build)
 ...
 * DAT_004baeb0, error tag "some" 0x656d6f73 and element 0x28); else returns
 * the empty string. Ends with the thread epilogue. Faithful error-string
 * construction.
 * Confidence: medium (faithful error build)
 * Notes: "some" tag 0x656d6f73; type descriptor DAT_004baeb0.
 */
void sk_string_error_build(void)
{
    /* FUN_0008e518(); FUN_00353aa0(); FUN_000a6f88(); (*DAT_00658c00)(x8+0x40);
     * FUN_00349db0(); (*DAT_00658c00)(); FUN_0034c2d8(); pcVar5=*(x16+0x10);
     ...
     *   uVar1=DAT_004baeb0; *(lVar3+0x18)=uRam_4baeb8; *(lVar3+0x10)=uVar1;
...
/* FUN_002652a4 @ 0x002652a4   (est. sk_string_error_result)
 * Ghidra: void FUN_002652a4(undefined8*)
