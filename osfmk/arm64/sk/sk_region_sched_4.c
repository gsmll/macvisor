...
extern uint sk_r4_001c4458(void);
...

{
  ...
  sk_r4_001cc9c8((uint64_t)0, (uint64_t)0);
  sk_h_00359c4c();
  *(uint8_t *)(p1 + 0x18) = iw3;
  return;
}
...
LAB_001cf6e4:
      ...
      sk_h_00357564();
      sk_h_0035072c();
      sk_r4_001cf6f4((uint64_t)0, (uint64_t)0, (uint64_t)0);
      v19 = v19 + 4;
    }
LAB_001cec80:
    sk_free(stk_98);
...
LAB_001cf090:
      ...
      while( true ) {
        ...
        sk_r4_001cf6f4(stk_70, xo15, (uint64_t)0);
      }
      sk_swift_release(stk_30);
    }
    else {
