...
/* Ghidra  */ extern uint64_t sk_console();
/* Ghidra  */ extern uint64_t sk_ctx_abort();
/* Ghidra  */ extern uint64_t sk_ctx_abort2();
/* Ghidra  */ extern uint64_t sk_ctx_alloc();
/* Ghidra  */ extern uint64_t sk_ctx_cpsr();
/* Ghidra  */ extern uint64_t sk_ctx_dbg();
/* Ghidra  */ extern uint64_t sk_ctx_el();
/* Ghidra  */ extern uint64_t sk_ctx_exc();
/* Ghidra  */ extern uint64_t sk_ctx_fault();
/* Ghidra  */ extern sk_u128_t sk_ctx_finish();
/* Ghidra  */ extern uint64_t sk_ctx_flag();
/* Ghidra  */ extern uint64_t sk_ctx_fp();
/* Ghidra  */ extern uint64_t sk_ctx_id();
/* Ghidra  */ extern uint64_t sk_ctx_ip();
/* Ghidra  */ extern uint64_t sk_ctx_irq();
/* Ghidra  */ extern uint64_t sk_ctx_meta();
/* Ghidra  */ extern uint64_t sk_ctx_owner();
/* Ghidra  */ extern uint64_t sk_ctx_panic();
/* Ghidra  */ extern uint64_t sk_ctx_pop();
...
/* Ghidra  */ extern uint64_t sk_ctx_vm2();
/* Ghidra  */ extern uint64_t sk_current_thread();
/* Ghidra  */ extern uint64_t sk_debug();
/* Ghidra  */ extern uint64_t sk_disable_preempt();
/* Ghidra  */ extern uint64_t sk_domain_state();
/* Ghidra  */ extern uint64_t sk_enable_preempt();
/* Ghidra  */ extern uint64_t sk_hexdump();
/* Ghidra  */ extern uint64_t sk_klog();
/* Ghidra  */ extern uint64_t sk_klog2();
/* Ghidra  */ extern uint64_t sk_klog3();
/* Ghidra  */ extern uint64_t sk_klog4();
/* Ghidra  */ extern uint64_t sk_log_char();
/* Ghidra  */ extern uint64_t sk_log_fmt();
/* Ghidra  */ extern uint64_t sk_log_str();
/* Ghidra  */ extern uint64_t sk_log_v();
/* Ghidra  */ extern uint64_t sk_macho_dysymtab();
/* Ghidra  */ extern uint64_t sk_macho_hdr();
/* Ghidra  */ extern uint64_t sk_macho_loadcmds();
/* Ghidra  */ extern sk_u128_t sk_macho_segcmd();
...
/* Ghidra  */ extern uint64_t sk_rt_dbg();
/* Ghidra  */ extern uint64_t sk_rt_done();
/* Ghidra  */ extern uint64_t sk_rt_error();
/* Ghidra  */ extern uint64_t sk_rt_flags();
/* Ghidra  */ extern uint64_t sk_rt_list();
/* Ghidra  */ extern uint64_t sk_rt_list2();
/* Ghidra  */ extern uint64_t sk_rt_lock();
/* Ghidra  */ extern uint64_t sk_rt_log();
/* Ghidra  */ extern uint64_t sk_rt_meta();
/* Ghidra  */ extern uint64_t sk_rt_park();
/* Ghidra  */ extern uint64_t sk_rt_phase();
/* Ghidra  */ extern uint64_t sk_rt_proc();
/* Ghidra  */ extern uint64_t sk_rt_proc10();
/* Ghidra  */ extern uint64_t sk_rt_proc11();
/* Ghidra  */ extern uint64_t sk_rt_proc12();
/* Ghidra  */ extern uint64_t sk_rt_proc2();
/* Ghidra  */ extern uint64_t sk_rt_proc3();
/* Ghidra  */ extern uint64_t sk_rt_proc4();
/* Ghidra  */ extern uint64_t sk_rt_proc5();
/* Ghidra  */ extern uint64_t sk_rt_proc6();
/* Ghidra  */ extern uint64_t sk_rt_proc7();
/* Ghidra  */ extern uint64_t sk_rt_proc8();
/* Ghidra  */ extern uint64_t sk_rt_proc9();
/* Ghidra  */ extern uint64_t sk_rt_run();
/* Ghidra  */ extern uint64_t sk_rt_state();
/* Ghidra  */ extern uint64_t sk_rt_sync();
/* Ghidra  */ extern uint64_t sk_rt_sync2();
/* Ghidra  */ extern uint64_t sk_rt_unlock();
/* Ghidra  */ extern uint64_t sk_rt_unpark();
...
/* Ghidra  */ extern uint64_t sk_timer();
/* Ghidra  */ extern uint64_t sk_tlb_flush();
/* Ghidra  */ extern uint64_t sk_trace();
/* Ghidra  */ extern uint64_t sk_trap();
/* Ghidra  */ extern uint64_t sk_trap2();
/* Ghidra  */ extern uint64_t sk_trap3();
/* Ghidra  */ extern uint64_t sk_trap4();
/* Ghidra  */ extern uint64_t sk_vsnprintf();
/* Ghidra  */ extern sk_u128_t sk_vspace_get_ops();
/* Ghidra  */ extern uint64_t sk_vspace_op2();
/* Ghidra  */ extern uint64_t sk_xrt_abort();
/* Ghidra  */ extern uint64_t sk_xrt_init();
...
extern uintptr_t sk_global_061;  /* Ghidra DAT_/global */
extern uintptr_t sk_global_062;  /* Ghidra DAT_/global */
extern uintptr_t sk_global_063;  /* Ghidra DAT_/global */
...
extern uint64_t sk_rt_runflags;  /* Ghidra run-flags global */
...
extern uint64_t sk_global_119;  /* Ghidra DAT_/global */
extern uint64_t sk_global_120;  /* Ghidra DAT_/global */
extern uint64_t sk_global_121;  /* Ghidra DAT_/global */
extern uint64_t sk_global_122;  /* Ghidra DAT_/global */
extern uint64_t sk_global_123;  /* Ghidra DAT_/global */
extern uint64_t sk_global_124;  /* Ghidra DAT_/global */
extern uint64_t sk_global_125;  /* Ghidra DAT_/global */
extern uint64_t sk_global_126;  /* Ghidra DAT_/global */
...
void sk_ipc_msg_read(uintptr_t arg1, uint8_t arg2, ...);
void sk_ipc_src_cap(long *arg1,long arg2,uint8_t *arg3);
uint64_t sk_ipc_src_map(long arg1,unsigned long arg2,long arg3);
uint8_t sk_ipc_cap_check(uintptr_t arg1, uintptr_t arg2);
unsigned long sk_sec_region_find(uintptr_t arg1, unsigned long arg2);
...
uint64_t sk_tcb_an(void);
uint64_t sk_tcb_ao(void);
...
uintptr_t sk_global_get(uintptr_t arg1, uint64_t arg2, uint64_t arg3);
uint64_t sk_error_clear(void);
...
void sk_panic_msg(uintptr_t arg1, uintptr_t arg2, ...);
void sk_panic(unsigned long arg1,uint64_t arg2,uint64_t arg3);
void sk_format_vsnprintf(void *arg1,uint64_t arg2,uint64_t arg3,void *arg4);
uint64_t sk_kernel_state_get(uint64_t *arg1);
uint64_t sk_kernel_field_40(void);
uint32_t sk_format_uuid(void);
...
uintptr_t sk_set_cap_class(uint8_t arg1, ...);
...
void sk_unlock(unsigned long *arg1);
...
LAB_00050440:
  ...
  do {
    ...
    if (*(char *)(t1 + 1) < '\0') {
      t6 = t1[7];
      ((uint8_t *)stk1[1]stk1)[1] = 0;
      ((uint8_t *)stk1[0]stk1)[0] = t4;
...
void sk_ipc_scan(long *arg1)
{
  ...
  if ((t6 == 0) || (t6 <= t6 + 8)) {
    ...
    t6 = (**(sk_code_t *)(stk1.hi + 0x30))(stk1.lo,0x1800,stk5,&stk7,0,0);
    t6 = t6 & 0xff;
    if (t6 == 0) {
      ...
      sk_panic_msg(0,(uint64_t)(void *)sk_str_06);
    }
  }
LAB_00050c80:
...
uint64_t sk_ipc_msg_write(long *arg1,long arg2,unsigned short *arg3)
{
  ...
  if (t7 != 0) {
    ...
    t6 = (**(sk_code_t *)(stk0.hi + 0x30))(stk0.lo,0x1a08,stk5,&stk2,0,0);
    if (t6 != '\0') {
      return 0;
    }
  ...
  if (0x3fff < arg4) {
    ...
    do {
      ...
      *t3 = 0x11;
      t3[1] = 0;
      if (arg1 != 0) {
        sk_ipc_msg_read((uintptr_t)(void *)stk0,(uint8_t)arg1);
        t2 = sk_str_05;
LAB_00051340:
 ...
 * Ghidra: void FUN_00051350(uintptr_t arg1, uint8_t arg2, ...)
 ...
 * Ghidra: uint8_t FUN_00051920(uintptr_t arg1, uintptr_t arg2)
 ...
 * Ghidra: ulong FUN_000519c8(uintptr_t arg1, ulong arg2)
 ...
 * Ghidra: ulong FUN_00051e5c(uintptr_t arg1, uintptr_t arg2, ...)
...
void sk_macho_layout(long arg1,unsigned long *arg2,unsigned long *arg3,long *arg4)
{
  ...
  t0 = sk_macho_seg_by(arg1,(uint64_t)(void *)sk_str_65);
  ...
  if (*(unsigned int *)(arg1 + 0x10) != 0) {
    ...
    do {
      if (*t4 == 2) {
        t1 = sk_macho_seg_by(arg1,(uint64_t)(void *)sk_str_62);
  ...
  sk_macho_seg_by(arg1,(uint64_t)(void *)sk_str_62);
LAB_00052068:
  t0 = 0;
  *arg2 = 0;
  *arg3 = 0;
...
LAB_00052570:
      ...
      if ((sk_global_046 & 1) == 0) {
        ...
        t17 = (uint64_t)(uintptr_t)sk_boot_list();
        ...
        *t7 = t17;
        ...
        if (sk_global_065 != (sk_code_t )0x0) {
          (*(void (**)(void))(uintptr_t)sk_global_065)();
        }
        sk_shift_dispatch();
        t1 = sk_domain_state();
        if (t1 != 0) {
        ...
        t17 = sk_ctx_flag();
        stk0 = sk_boot_heap();
        (**(sk_code_t *)(stk0.hi + 0x20))(t17,stk0.lo);
        sk_debug(0);
        sk_console();
 ...
 * Ghidra: void FUN_0005295c(uintptr_t arg1)
...
uint64_t sk_cnode_op(unsigned long arg1,unsigned long arg2,uint8_t (*arg3) [16],unsigned int arg4)
{
  ...
  t3 = stk0.hi;
  t5 = stk0.lo;
  ((uint8_t *)stk1[2]stk1)[2] = 0;
  ((uint8_t *)stk1[1]stk1)[1] = 0;
  ((uint8_t *)stk1[4]stk1)[4] = 0;
  ((uint8_t *)stk1[3]stk1)[3] = 0;
  if (t5 == 0) {
LAB_00054210:
...
LAB_00054220:
    ...
    *t7 = t11;
    ...
    if ((((arg1 < ((uint8_t *)stk1[2]stk1)[2]) || (((uint8_t *)stk1[3]stk1)[3] < arg2)) ||
        (((uint8_t *)stk1[3]stk1)[3] + ((uint8_t *)stk1[2]stk1)[2] <= arg1)) || (((uint8_t *)stk1[3]stk1)[3] + ((uint8_t *)stk1[2]stk1)[2] < arg2 + arg1))
    goto LAB_00054210;
    t8 = arg1 - ((uint8_t *)stk1[2]stk1)[2] & 0xffffffffffffc000;
    t4 = (arg2 + 0x3fff + (arg1 - ((uint8_t *)stk1[2]stk1)[2]) & 0xffffffffffffc000) - t8;
    if ((arg4 & 0xc) == 0) {
LAB_000542e8:
      if ((arg4 & 3) == 0) {
        t0 = '\0';
        ...
        stk2 = t4;
        ((uint8_t *)stk1[0]stk1)[0] = t8;
        t0 = (**(sk_code_t *)(t3 + t2))(t5,stk1,&stk2);
        if ((((uint8_t *)stk1[0]stk1)[0] != t8) || (stk2 != t4)) {
          sk_rt_sync2();
LAB_0005434c:
...
void sk_tcb_abort(uintptr_t arg1, ...){
  ...
  sk_panic_msg(t1,(uint64_t)(void *)sk_str_80);
}
 ...
 * Ghidra: uintptr_t FUN_00054610(void)
...
uint8_t * sk_setup_cpu_regs(long arg1)
{
  ...
  sk_register_global((long *)0x64ccb8);
...
bool sk_tcb_ar(long arg1,long arg2)
{
  if (arg1 == 2) {
    ...
    *(uint8_t **)(arg2 + 0x28) = (void *)0x00055e24;
    *(uint8_t *)(arg2 + 0x30) = 0;
    ...
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x00055e44;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x00055e4c;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x00055e54;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x00055e5c;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x00055e64;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x00055e6c;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x00055e74;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x00055e7c;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x00055e9c;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x00055eb8;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x00055ed0;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x00055ed8;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)sk_tcb_as;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)sk_tcb_at;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x00055f0c;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)sk_tcb_au;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x00055f28;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x00055f48;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)sk_tcb_av;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x00055f68;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x00055fb0;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x00055ff0;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x00055ff8;
...
bool sk_tcb_aw(long arg1,long arg2)
{
  if (arg1 == 1) {
    ...
    *(uint8_t **)(arg2 + 0x40) = (void *)0x00056410;
    *(uint8_t **)(arg2 + 0x48) = (void *)0x00056428;
    *(uint8_t **)(arg2 + 0x50) = (void *)0x00056440;
    *(sk_code_t *)(arg2 + 0x58) = (sk_code_t)sk_cap_op_b;
    *(uint8_t **)(arg2 + 0x60) = (void *)0x0005645c;
    *(sk_code_t *)(arg2 + 0x68) = (sk_code_t)sk_cap_op_c;
    *(uint8_t **)(arg2 + 0x70) = (void *)0x00056474;
    *(uint8_t **)(arg2 + 0x78) = (void *)0x000564ac;
    *(uint8_t **)(arg2 + 0x80) = (void *)0x000564c4;
    *(uint8_t **)(arg2 + 0x88) = (void *)0x000564dc;
    *(uint8_t **)(arg2 + 0x90) = (void *)0x00056504;
    *(sk_code_t *)(arg2 + 0x98) = (sk_code_t)sk_cap_op_d;
    *(uint8_t *)(arg2 + 0xa0) = 1;
    *(uint32_t *)(arg2 + 0xa4) = 4;
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x00056528;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x00056530;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x00056538;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x00056540;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x00056548;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x00056550;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x00056558;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x00056560;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x00056580;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x0005659c;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x000565b4;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x000565bc;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)sk_cap_op_a;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)sk_cap_op_e;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x000565f0;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)sk_cap_op_f;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x0005660c;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x0005662c;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)sk_cap_op_g;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x0005664c;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x00056694;
    *(uint8_t *)(arg2 + 0x140) = 1;
    *(uint32_t *)(arg2 + 0x144) = 5;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x000566d4;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x000566dc;
    *(uint8_t *)(arg2 + 0x1a8) = 1;
...
bool sk_cap_cmp(long arg1,long arg2)
{
  if (arg1 == 0x100000001) {
    ...
    *(uint32_t *)(arg2 + 0x34) = 3;
    *(int *)(arg2 + 0x38) = (int)sk_global_005;
    *(uint8_t **)(arg2 + 0x40) = (void *)0x00056b88;
    *(uint8_t **)(arg2 + 0x48) = (void *)0x00056ba0;
    *(uint8_t **)(arg2 + 0x50) = (void *)0x00056bb8;
    *(sk_code_t *)(arg2 + 0x58) = (sk_code_t)sk_cap_op_i;
    *(uint8_t **)(arg2 + 0x60) = (void *)0x00056bd4;
    *(sk_code_t *)(arg2 + 0x68) = (sk_code_t)sk_cap_op_j;
    *(uint8_t **)(arg2 + 0x70) = (void *)0x00056bec;
    *(uint8_t **)(arg2 + 0x78) = (void *)0x00056c24;
    *(uint8_t **)(arg2 + 0x80) = (void *)0x00056c3c;
    *(uint8_t **)(arg2 + 0x88) = (void *)0x00056c54;
    *(uint8_t **)(arg2 + 0x90) = (void *)0x00056c7c;
    *(sk_code_t *)(arg2 + 0x98) = (sk_code_t)sk_cap_op_k;
    *(uint8_t *)(arg2 + 0xa0) = 1;
    *(uint32_t *)(arg2 + 0xa4) = 4;
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x00056ca0;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x00056ca8;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x00056cb0;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x00056cb8;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x00056cc0;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x00056cc8;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x00056cd0;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x00056cd8;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x00056cf8;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x00056d14;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x00056d2c;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x00056d34;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)sk_cap_op_h;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)sk_cap_op_l;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x00056d68;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)sk_cap_op_m;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x00056d84;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x00056da4;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)sk_cap_op_n;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x00056dc4;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x00056e0c;
    *(uint8_t *)(arg2 + 0x140) = 1;
    *(uint32_t *)(arg2 + 0x144) = 5;
    *(uint8_t *)(arg2 + 0x148) = 0;
    *(uint8_t *)(arg2 + 0x178) = 0x1a;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x00056e4c;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x00056e54;
    *(uint8_t *)(arg2 + 0x1a8) = 1;
    *(uint64_t *)(arg2 + 0x1b0) = 1;
    *(uint32_t *)(arg2 + 0x1b8) = 0;
  }
...
bool sk_cap_cmp2(long arg1,long arg2)
{
  if (arg1 == 0x200000001) {
    ...
    *(uint32_t *)(arg2 + 0x34) = 3;
    *(int *)(arg2 + 0x38) = (int)sk_global_005;
    *(uint8_t **)(arg2 + 0x40) = (void *)0x0005730c;
    *(uint8_t **)(arg2 + 0x48) = (void *)0x00057324;
    *(uint8_t **)(arg2 + 0x50) = (void *)0x0005733c;
    *(sk_code_t *)(arg2 + 0x58) = (sk_code_t)sk_cap_op_p;
    *(uint8_t **)(arg2 + 0x60) = (void *)0x00057358;
    *(sk_code_t *)(arg2 + 0x68) = (sk_code_t)sk_cap_op_q;
    *(uint8_t **)(arg2 + 0x70) = (void *)0x00057370;
    *(uint8_t **)(arg2 + 0x78) = (void *)0x000573a8;
    *(uint8_t **)(arg2 + 0x80) = (void *)0x000573c0;
    *(uint8_t **)(arg2 + 0x88) = (void *)0x000573d8;
    *(uint8_t **)(arg2 + 0x90) = (void *)0x00057400;
    *(sk_code_t *)(arg2 + 0x98) = (sk_code_t)sk_cap_op_r;
    *(uint8_t *)(arg2 + 0xa0) = 1;
    *(uint32_t *)(arg2 + 0xa4) = 4;
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x00057424;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x0005742c;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x00057434;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x0005743c;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x00057444;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x0005744c;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x00057454;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x0005745c;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x0005747c;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x00057498;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x000574b0;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x000574b8;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)sk_cap_op_o;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)sk_cap_op_s;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x000574ec;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)sk_cap_op_t;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x00057508;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x00057528;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)sk_cap_op_u;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x00057548;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x00057590;
    *(uint8_t *)(arg2 + 0x140) = 1;
    *(uint32_t *)(arg2 + 0x144) = 5;
    *(uint8_t *)(arg2 + 0x148) = 0;
    *(uint8_t *)(arg2 + 0x178) = 0x1a;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x000575d0;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x000575d8;
    *(uint8_t *)(arg2 + 0x1a8) = 1;
    *(uint64_t *)(arg2 + 0x1b0) = 1;
...
bool sk_cap_cmp3(long arg1,long arg2)
{
  if (arg1 == 0x300000001) {
    ...
    *(uint32_t *)(arg2 + 0x34) = 3;
    *(int *)(arg2 + 0x38) = (int)sk_global_005;
    *(uint8_t **)(arg2 + 0x40) = (void *)0x00057a90;
    *(uint8_t **)(arg2 + 0x48) = (void *)0x00057aa8;
    *(uint8_t **)(arg2 + 0x50) = (void *)0x00057ac0;
    *(sk_code_t *)(arg2 + 0x58) = (sk_code_t)sk_cap_op_w;
    *(uint8_t **)(arg2 + 0x60) = (void *)0x00057adc;
    *(sk_code_t *)(arg2 + 0x68) = (sk_code_t)sk_cap_op_x;
    *(uint8_t **)(arg2 + 0x70) = (void *)0x00057af4;
    *(uint8_t **)(arg2 + 0x78) = (void *)0x00057b2c;
    *(uint8_t **)(arg2 + 0x80) = (void *)0x00057b44;
    *(uint8_t **)(arg2 + 0x88) = (void *)0x00057b5c;
    *(uint8_t **)(arg2 + 0x90) = (void *)0x00057b84;
    *(sk_code_t *)(arg2 + 0x98) = (sk_code_t)sk_cap_op_y;
    *(uint8_t *)(arg2 + 0xa0) = 1;
    *(uint32_t *)(arg2 + 0xa4) = 4;
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x00057ba8;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x00057bb0;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x00057bb8;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x00057bc0;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x00057bc8;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x00057bd0;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x00057bd8;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x00057be0;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x00057c00;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x00057c1c;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x00057c34;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x00057c3c;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)sk_cap_op_v;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)sk_cap_op_z;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x00057c70;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)sk_cap_op_aa;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x00057c8c;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x00057cac;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)sk_cap_op_ab;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x00057ccc;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x00057d14;
    *(uint8_t *)(arg2 + 0x140) = 1;
    *(uint32_t *)(arg2 + 0x144) = 5;
    *(uint8_t *)(arg2 + 0x148) = 0;
    *(uint8_t *)(arg2 + 0x178) = 0x1a;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x00057d54;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x00057d5c;
    *(uint8_t *)(arg2 + 0x1a8) = 1;
    *(uint64_t *)(arg2 + 0x1b0) = 1;
    *(int *)(arg2 + 0x1b8) = (int)sk_global_006;
  }
...
bool sk_cap_cmp4(long arg1,long arg2)
{
  if (arg1 == 0x400000001) {
    ...
    *(uint32_t *)(arg2 + 0x34) = 3;
    *(int *)(arg2 + 0x38) = (int)sk_global_005;
    *(uint8_t **)(arg2 + 0x40) = (void *)0x00058210;
    *(uint8_t **)(arg2 + 0x48) = (void *)0x00058228;
    *(uint8_t **)(arg2 + 0x50) = (void *)0x00058240;
    *(sk_code_t *)(arg2 + 0x58) = (sk_code_t)sk_cap_op_ad;
    *(uint8_t **)(arg2 + 0x60) = (void *)0x0005825c;
    *(sk_code_t *)(arg2 + 0x68) = (sk_code_t)sk_cap_op_ae;
    *(uint8_t **)(arg2 + 0x70) = (void *)0x00058274;
    *(uint8_t **)(arg2 + 0x78) = (void *)0x000582ac;
    *(uint8_t **)(arg2 + 0x80) = (void *)0x000582c4;
    *(uint8_t **)(arg2 + 0x88) = (void *)0x000582dc;
    *(uint8_t **)(arg2 + 0x90) = (void *)0x00058304;
    *(sk_code_t *)(arg2 + 0x98) = (sk_code_t)sk_cap_op_af;
    *(uint8_t *)(arg2 + 0xa0) = 1;
    *(uint32_t *)(arg2 + 0xa4) = 4;
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x00058328;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x00058330;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x00058338;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x00058340;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x00058348;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x00058350;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x00058358;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x00058360;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x00058380;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x0005839c;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x000583b4;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x000583bc;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)sk_cap_op_ac;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)sk_cap_op_ag;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x000583f0;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)sk_cap_op_ah;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x0005840c;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x0005842c;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)sk_cap_op_ai;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x0005844c;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x00058494;
    *(uint8_t *)(arg2 + 0x140) = 1;
    *(uint32_t *)(arg2 + 0x144) = 5;
    *(uint8_t *)(arg2 + 0x148) = 0;
    *(uint8_t *)(arg2 + 0x178) = 0x1a;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x000584d4;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x000584dc;
    *(uint8_t *)(arg2 + 0x1a8) = 1;
    *(uint64_t *)(arg2 + 0x1b0) = 1;
...
bool sk_cap_cmp5(long arg1,long arg2)
{
  if (arg1 == 0x500000001) {
    ...
    *(uint32_t *)(arg2 + 0x34) = 3;
    *(int *)(arg2 + 0x38) = (int)sk_global_005;
    *(uint8_t **)(arg2 + 0x40) = (void *)0x00058990;
    *(uint8_t **)(arg2 + 0x48) = (void *)0x000589a8;
    *(uint8_t **)(arg2 + 0x50) = (void *)0x000589c0;
    *(sk_code_t *)(arg2 + 0x58) = (sk_code_t)sk_cap_op_ak;
    *(uint8_t **)(arg2 + 0x60) = (void *)0x000589dc;
    *(sk_code_t *)(arg2 + 0x68) = (sk_code_t)sk_cap_op_al;
    *(uint8_t **)(arg2 + 0x70) = (void *)0x000589f4;
    *(uint8_t **)(arg2 + 0x78) = (void *)0x00058a2c;
    *(uint8_t **)(arg2 + 0x80) = (void *)0x00058a44;
    *(uint8_t **)(arg2 + 0x88) = (void *)0x00058a5c;
    *(uint8_t **)(arg2 + 0x90) = (void *)0x00058a84;
    *(sk_code_t *)(arg2 + 0x98) = (sk_code_t)sk_cap_op_am;
    *(uint8_t *)(arg2 + 0xa0) = 1;
    *(uint32_t *)(arg2 + 0xa4) = 4;
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x00058aa8;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x00058ab0;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x00058ab8;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x00058ac0;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x00058ac8;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x00058ad0;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x00058ad8;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x00058ae0;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x00058b00;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x00058b1c;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x00058b34;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x00058b3c;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)sk_cap_op_aj;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)sk_cap_op_an;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x00058b70;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)sk_cap_op_ao;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x00058b8c;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x00058bac;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)sk_cap_op_ap;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x00058bcc;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x00058c14;
    *(uint8_t *)(arg2 + 0x140) = 1;
    *(uint32_t *)(arg2 + 0x144) = 5;
    *(uint8_t *)(arg2 + 0x148) = 0;
    *(uint8_t *)(arg2 + 0x178) = 0x1a;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x00058c54;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x00058c5c;
    *(uint8_t *)(arg2 + 0x1a8) = 1;
    *(uint64_t *)(arg2 + 0x1b0) = 1;
    *(uint32_t *)(arg2 + 0x1b8) = 1;
  }
...
bool sk_cap_cmp6(long arg1,long arg2)
{
  if (arg1 == 0x600000001) {
    ...
    *(uint32_t *)(arg2 + 0x34) = 3;
    *(int *)(arg2 + 0x38) = (int)sk_global_005;
    *(uint8_t **)(arg2 + 0x40) = (void *)0x00059110;
    *(uint8_t **)(arg2 + 0x48) = (void *)0x00059128;
    *(uint8_t **)(arg2 + 0x50) = (void *)0x00059140;
    *(sk_code_t *)(arg2 + 0x58) = (sk_code_t)sk_cap_op_ar;
    *(uint8_t **)(arg2 + 0x60) = (void *)0x0005915c;
    *(sk_code_t *)(arg2 + 0x68) = (sk_code_t)sk_cap_op_as;
    *(uint8_t **)(arg2 + 0x70) = (void *)0x00059174;
    *(uint8_t **)(arg2 + 0x78) = (void *)0x000591ac;
    *(uint8_t **)(arg2 + 0x80) = (void *)0x000591c4;
    *(uint8_t **)(arg2 + 0x88) = (void *)0x000591dc;
    *(uint8_t **)(arg2 + 0x90) = (void *)0x00059204;
    *(sk_code_t *)(arg2 + 0x98) = (sk_code_t)sk_cap_op_at;
    *(uint8_t *)(arg2 + 0xa0) = 1;
    *(uint32_t *)(arg2 + 0xa4) = 4;
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x00059228;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x00059230;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x00059238;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x00059240;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x00059248;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x00059250;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x00059258;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x00059260;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x00059280;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x0005929c;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x000592b4;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x000592bc;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)sk_cap_op_aq;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)sk_cap_op_au;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x000592f0;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)sk_cap_op_av;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x0005930c;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x0005932c;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)sk_cap_op_aw;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x0005934c;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x00059394;
    *(uint8_t *)(arg2 + 0x140) = 1;
    *(uint32_t *)(arg2 + 0x144) = 5;
    *(uint8_t *)(arg2 + 0x148) = 0;
    *(uint8_t *)(arg2 + 0x178) = 0x1a;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x000593d4;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x000593dc;
    *(uint8_t *)(arg2 + 0x1a8) = 1;
    *(uint64_t *)(arg2 + 0x1b0) = 1;
    *(uint32_t *)(arg2 + 0x1b8) = 1;
  }
...
bool sk_cap_cmp7(long arg1,long arg2)
{
  if (arg1 == 0x700000001) {
    ...
    *(uint32_t *)(arg2 + 0x34) = 3;
    *(int *)(arg2 + 0x38) = (int)sk_global_005;
    *(uint8_t **)(arg2 + 0x40) = (void *)0x00059890;
    *(uint8_t **)(arg2 + 0x48) = (void *)0x000598a8;
    *(uint8_t **)(arg2 + 0x50) = (void *)0x000598c0;
    *(sk_code_t *)(arg2 + 0x58) = (sk_code_t)sk_cap_op_ay;
    *(uint8_t **)(arg2 + 0x60) = (void *)0x000598dc;
    *(sk_code_t *)(arg2 + 0x68) = (sk_code_t)sk_cap_op_az;
    *(uint8_t **)(arg2 + 0x70) = (void *)0x000598f4;
    *(uint8_t **)(arg2 + 0x78) = (void *)0x0005992c;
    *(uint8_t **)(arg2 + 0x80) = (void *)0x00059944;
    *(uint8_t **)(arg2 + 0x88) = (void *)0x0005995c;
    *(uint8_t **)(arg2 + 0x90) = (void *)0x00059984;
    *(sk_code_t *)(arg2 + 0x98) = (sk_code_t)sk_cap_op_ba;
    *(uint8_t *)(arg2 + 0xa0) = 1;
    *(uint32_t *)(arg2 + 0xa4) = 4;
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x000599a8;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x000599b0;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x000599b8;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x000599c0;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x000599c8;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x000599d0;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x000599d8;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x000599e0;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x00059a00;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x00059a1c;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x00059a34;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x00059a3c;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)sk_cap_op_ax;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)sk_cap_op_bb;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x00059a70;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)sk_cap_op_bc;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x00059a8c;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x00059aac;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)sk_cap_op_bd;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x00059acc;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x00059b14;
    *(uint8_t *)(arg2 + 0x140) = 1;
    *(uint32_t *)(arg2 + 0x144) = 5;
    *(uint8_t *)(arg2 + 0x148) = 0;
    *(uint8_t *)(arg2 + 0x178) = 0x1a;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x00059b54;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x00059b5c;
    *(uint8_t *)(arg2 + 0x1a8) = 1;
    *(uint64_t *)(arg2 + 0x1b0) = 1;
    *(uint32_t *)(arg2 + 0x1b8) = 1;
  }
...
bool sk_cap_cmp8(long arg1,long arg2)
{
  if (arg1 == 0x800000001) {
    ...
    *(uint32_t *)(arg2 + 0x34) = 3;
    *(int *)(arg2 + 0x38) = (int)sk_global_005;
    *(uint8_t **)(arg2 + 0x40) = (void *)0x0005a010;
    *(uint8_t **)(arg2 + 0x48) = (void *)0x0005a028;
    *(uint8_t **)(arg2 + 0x50) = (void *)0x0005a040;
    *(sk_code_t *)(arg2 + 0x58) = (sk_code_t)svc_repeat_on_suspend_1;
    *(uint8_t **)(arg2 + 0x60) = (void *)0x0005a05c;
    *(sk_code_t *)(arg2 + 0x68) = (sk_code_t)svc_repeat_on_suspend_2;
    *(uint8_t **)(arg2 + 0x70) = (void *)0x0005a074;
    *(uint8_t **)(arg2 + 0x78) = (void *)0x0005a0ac;
    *(uint8_t **)(arg2 + 0x80) = (void *)0x0005a0c4;
    *(uint8_t **)(arg2 + 0x88) = (void *)0x0005a0dc;
    *(uint8_t **)(arg2 + 0x90) = (void *)0x0005a104;
    *(sk_code_t *)(arg2 + 0x98) = (sk_code_t)svc_repeat_on_suspend_3;
    *(uint8_t *)(arg2 + 0xa0) = 1;
    *(uint32_t *)(arg2 + 0xa4) = 4;
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x0005a128;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x0005a130;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x0005a138;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x0005a140;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x0005a148;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x0005a150;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x0005a158;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x0005a160;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x0005a180;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x0005a19c;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x0005a1b4;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x0005a1bc;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)svc_dispatch_3arg;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)svc_repeat_on_suspend_4;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x0005a1f0;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)svc_repeat_on_suspend_5;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x0005a20c;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x0005a22c;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)svc_set_arg_repeat_on_suspend;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x0005a24c;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x0005a294;
    *(uint8_t *)(arg2 + 0x140) = 1;
    *(uint32_t *)(arg2 + 0x144) = 5;
    *(uint8_t *)(arg2 + 0x148) = 0;
    *(uint8_t *)(arg2 + 0x178) = 0x1a;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x0005a2d4;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x0005a2dc;
    *(uint8_t *)(arg2 + 0x1a8) = 1;
    *(uint64_t *)(arg2 + 0x1b0) = 1;
    *(uint32_t *)(arg2 + 0x1b8) = 1;
  }
...
bool fill_cap_dispatch_table(long arg1,long arg2)
{
  if (arg1 == 0x900000001) {
    ...
    *(uint32_t *)(arg2 + 0x34) = 3;
    *(int *)(arg2 + 0x38) = (int)sk_global_005;
    *(uint8_t **)(arg2 + 0x40) = (void *)0x0005a78c;
    *(uint8_t **)(arg2 + 0x48) = (void *)0x0005a7a4;
    *(uint8_t **)(arg2 + 0x50) = (void *)0x0005a7bc;
    *(sk_code_t *)(arg2 + 0x58) = (sk_code_t)svc_repeat_on_suspend_6;
    *(uint8_t **)(arg2 + 0x60) = (void *)0x0005a7d8;
    *(sk_code_t *)(arg2 + 0x68) = (sk_code_t)svc_repeat_on_suspend_7;
    *(uint8_t **)(arg2 + 0x70) = (void *)0x0005a7f0;
    *(uint8_t **)(arg2 + 0x78) = (void *)0x0005a828;
    *(uint8_t **)(arg2 + 0x80) = (void *)0x0005a840;
    *(uint8_t **)(arg2 + 0x88) = (void *)0x0005a858;
    *(uint8_t **)(arg2 + 0x90) = (void *)0x0005a880;
    *(sk_code_t *)(arg2 + 0x98) = (sk_code_t)svc_repeat_on_suspend_8;
    *(uint8_t *)(arg2 + 0xa0) = 1;
    *(uint32_t *)(arg2 + 0xa4) = 4;
    *(uint8_t **)(arg2 + 0xa8) = (void *)0x0005a8a4;
    *(uint8_t **)(arg2 + 0xb0) = (void *)0x0005a8ac;
    *(uint8_t **)(arg2 + 0xb8) = (void *)0x0005a8b4;
    *(uint8_t **)(arg2 + 0xc0) = (void *)0x0005a8bc;
    *(uint64_t *)(arg2 + 0xd0) = 0xc;
    *(uint8_t **)(arg2 + 0xd8) = (void *)0x0005a8c4;
    *(uint8_t **)(arg2 + 0xe0) = (void *)0x0005a8cc;
    *(uint8_t **)(arg2 + 0xe8) = (void *)0x0005a8d4;
    *(uint16_t *)(arg2 + 0xf0) = 0x1601;
    *(uint32_t *)(arg2 + 0xf4) = 3;
    *(uint8_t **)(arg2 + 0xf8) = (void *)0x0005a8dc;
    *(uint8_t **)(arg2 + 0x100) = (void *)0x0005a8fc;
    *(uint8_t **)(arg2 + 0x108) = (void *)0x0005a918;
    *(uint8_t **)(arg2 + 0x110) = (void *)0x0005a930;
    *(uint8_t **)(arg2 + 0x118) = (void *)0x0005a938;
    *(sk_code_t *)(arg2 + 0x120) = (sk_code_t)svc_dispatch_3arg_b;
    *(sk_code_t *)(arg2 + 0x128) = (sk_code_t)svc_repeat_on_suspend_9;
    *(uint8_t **)(arg2 + 0x130) = (void *)0x0005a96c;
    *(sk_code_t *)(arg2 + 0x138) = (sk_code_t)svc_repeat_on_suspend_10;
    *(uint16_t *)(arg2 + 0x149) = 0x1701;
    *(uint32_t *)(arg2 + 0x14c) = 1;
    *(uint8_t **)(arg2 + 0x150) = (void *)0x0005a988;
    *(uint8_t **)(arg2 + 0x158) = (void *)0x0005a9a8;
    *(sk_code_t *)(arg2 + 0x160) = (sk_code_t)svc_set_arg_repeat_on_suspend_b;
    *(uint8_t **)(arg2 + 0x168) = (void *)0x0005a9c8;
    *(uint8_t **)(arg2 + 0x170) = (void *)0x0005aa10;
    *(uint8_t *)(arg2 + 0x140) = 1;
    *(uint32_t *)(arg2 + 0x144) = 5;
    *(uint8_t *)(arg2 + 0x148) = 0;
    *(uint8_t *)(arg2 + 0x178) = 0x1a;
    ...
    *(uint8_t **)(arg2 + 0x198) = (void *)0x0005aa50;
    *(uint8_t **)(arg2 + 0x1a0) = (void *)0x0005aa58;
    *(uint8_t *)(arg2 + 0x1a8) = 1;
    *(uint64_t *)(arg2 + 0x1b0) = 1;
    *(uint32_t *)(arg2 + 0x1b8) = 0;
  }
...
uint32_t sk_error_register(unsigned long arg1,unsigned int arg2)
{
  ...
  if (t0 == 0) {
    ...
    if (stk0 < (arg1 & 0xffffffff)) {
      ...
      sk_panic_msg(t3,(uint64_t)(void *)sk_str_115);
    }
...
uintptr_t sk_global_get(uintptr_t arg1, uint64_t arg2, uint64_t arg3){
  ...
  if (*(long *)arg1 == 0) {
    t0 = sk_lookup_thread_obj((int)arg2,(int)arg3);
    *(long *)arg1 = t0;
  }
  return (uintptr_t)*(long *)arg1;
}
...
uint64_t sk_error_clear(void)
{
  ...
  if (t2 == 0) {
    ...
    sk_panic_msg(t3,(uint64_t)(void *)sk_str_40);
  }
  if (t2 <= t2 + 0x30) {
    return t2;
  }
    ...
    if ((t3 < t2 || t3 - t2 == 0) || ((t3 - t2) + *(long *)(arg1 + 0x60) < 5))
    {
      ...
      if (t3 != 0) {
        ...
        if ((&sk_global_034 <= &sk_global_034 + t3 && &sk_global_035 + t3 <= &sk_global_036) &&
          ...
          sk_panic_msg(t1,(uint64_t)(void *)sk_str_04);
        }
...
void sk_error_emit(uint64_t arg1,long arg2,uint64_t arg3,int arg4)
{
  ...
  if ((arg4 != 0) && (*(long *)(arg2 + 0x38) != 0)) {
    ...
    do {
      ...
      if (t0 == 0) break;
      stk3 = 0;
      sk_cnode_revoke(*t2,(uint64_t)&stk3);
...
void sk_error_broadcast(uintptr_t arg1, ...){
  ...
  sk_panic_msg(0,(uint64_t)(void *)sk_str_109);
}
 ...
 * Ghidra: void FUN_0005b190(uintptr_t arg1, uintptr_t arg2, ...)
...
void sk_panic_msg(uintptr_t arg1, uintptr_t arg2, ...){
  ...
  sk_panic(arg1,arg2,(uint64_t)NULL);
}
  ...
  if (((arg1 != 0) || (arg1 = t20, t20 <= t20 + 0x178)) &&
    ...
    *(unsigned long *)(t20 + 0x48) = *(unsigned long *)(t20 + 0x48) | 0x40;
    ...
    if (t12 <= t12 + 0x28) {
      ...
      stk13 = (uint64_t)sk_macho_uuid(t12);
      ...
      sk_syscall_print((long)stk1,0x6b04d0,0x2000,0);
      sk_boot_puts((uint64_t)sk_str_57,0x6b04d0,0x2000,0xeb1a02bf914012ba);
      t1 = 0;
      while (t1 != 0x2000) {
        t2 = (char *)(t1 + 0x6b04d0);
        t1 = t1 + 1;
 ...
 * Ghidra: void FUN_0005ba5c(uintptr_t arg1, ...)
...
void sk_register_cb(long arg1)
{
  ...
  if (arg1 + 8U <= arg1 + 0xcU) {
    sk_register_cb2((unsigned int *)(arg1 + 8U),(sk_code_t)sk_list_push_28,0);
    return;
  }
...
void sk_waitq_enqueue(unsigned long *arg1,int arg2)
{
  ...
  *t1 = (unsigned long)arg1;
  ...
  ((sk_code_t)sk_global_107)(arg1,1);
  return;
}
...
LAB_0005c06c:
  ...
  *arg1 = 0;
  if (sk_global_107 != (sk_code_t )0x0) {
    ((sk_code_t)sk_global_107)(arg1,0);
  }
  return;
}
...
long sk_cap_word_lookup(uint64_t arg1)
{
  ...
  if (t0 != 0) {
    stk0 = sk_boot_heap();
    t1 = (*(sk_code_t *)stk0.hi)(stk0.lo,arg1,t0,t0,0);
    if (t1 != 0) {
      sk_xrt_init(t0);
      t0 = 0;
    }
...
void sk_method_handle(uint64_t arg1)
{
  ...
  stk0 = sk_boot_heap();
  (**(sk_code_t *)(stk0.hi + 0x10))(stk0.lo,arg1);
  sk_xrt_init(arg1);
  return;
}
 ...
 * Ghidra: void FUN_0005c650(uintptr_t code, ...)
...
void sk_error_from_code(uintptr_t code, ...){
    ...
    lo = 0;
    hi = 0;
    sk_dispatch_record(code, (long)&lo);
...
void sk_dispatch_record(unsigned long arg1,long arg2)
{
  ...
  if ((int)arg1 - 1U < 3) {
    ...
    *(unsigned long *)(arg2 + 0x38) = t3;
    sk_cap_record(arg1,0xffffffffffffffff,(uint8_t (*)[16])(arg2 + 0x10),0);
    return;
  }
                    
  sk_panic_msg(0,(uint64_t)(void *)sk_str_95);
}
...
long sk_error_classify(uint64_t arg1,uint8_t (*arg2) [16],uint8_t (*arg3) [16], unsigned long arg4)
{
  ...
  stk10 = 0;
  stk4 = 0;
  sk_dispatch_record(arg1,(long)&stk4);
  t4 = stk9;
  t3 = stk3;
  ...
  if (t0 < 1) {
    ...
    t2 = 0;
    if (stk7 != 0) {
      t2 = (unsigned long)(stk1 * stk0.hi) / stk7;
    }
    t1 = t2 + stk2 * stk0.lo;
  }
  else {
 ...
 * Ghidra: uintptr_t FUN_0005cb18(uint8_t arg1, ...)
...
LAB_0005cc0c:
      sk_error_fmt(t1,(uint64_t)arg1,(uint64_t)NULL);
      return 0;
    }
  }
LAB_0005cc1c:
...
uint64_t sk_lock_acquire_recursive(unsigned long *arg1,uint64_t arg2)
{
  ...
  *(unsigned long *)(t1 + 0x78) = t7;
  ...
  if ((t7 != 0) && ((((unsigned int)t7 ^ (unsigned int)(t5 >> 0xe)) & 0xffffff) == 0)) {
    ...
    sk_panic_msg(t6,(uint64_t)(void *)sk_str_97);
  }
  if (t7 != 0) {
    t5 = 0;
    do {
...
LAB_0005ccc8:
  t6 = sk_current_thread();
  sk_error_fmt(t6,(uint64_t)arg1,(uint64_t)NULL);
  return 1;
}
 ...
 * Ghidra: void FUN_0005cf4c(uintptr_t arg1, ...)
...
LAB_0005d2f0:
  ...
  sk_lock_prepare((unsigned long *)arg2);
  return t12;
}
...
long sk_msg_send(long arg1,uint16_t arg2,uint64_t *arg3,unsigned long arg4)
{
  ...
  stk9 = '\0';
  t3 = sk_ipc_call_guard((sk_code_t)sk_ipc_msg_frame,arg1,t2,(uint64_t)&stk8);
  if ((t3 & 0xff) == 0) {
    t4 = 5;
    if (stk9 == '\0') {
      t4 = stk3;
...
uint64_t sk_ipc_retrieve(void)
{
  sk_register_cb2((unsigned int *)0x6b2680,(sk_code_t)sk_msg_push,(uint64_t)&sk_global_049);
...
void sk_msg_push(long *arg1)
{
  ...
  *arg1 = t1;
  if (t1 != 0) {
    stk0 = sk_vspace_get_ops();
    t0 = (**(sk_code_t *)(stk0.hi + 0x48))(stk0.lo,*arg1);
    if (t0 == '\0') {
      return;
    }
                    
    sk_panic_msg(0,(uint64_t)(void *)sk_str_113);
  }
                    
  sk_panic_msg(0,(uint64_t)(void *)sk_str_69);
}
...
LAB_0005de10:
      ...
      sk_panic_msg(0,(uint64_t)(void *)sk_str_94);
    }
    if (arg4 != 0) {
      arg3 = 4;
      t3 = arg4;
...
LAB_0005e490:
        ...
        sk_panic_msg(0,(uint64_t)(void *)sk_str_93);
      }
      if (stk1 == -0x2c8502b44bfffed6) {
        sk_xrt_init(t10,0);
        return;
...
void sk_syscall_set_table(unsigned int arg1,uint64_t arg2)
{
  ...
  sk_panic_msg(0,(uint64_t)(void *)sk_str_104);
}
...
unsigned long sk_syscall_get_table(unsigned int arg1)
{
  ...
  sk_panic_msg(0,(uint64_t)(void *)sk_str_91);
}
...
void sk_syscall_set_handlers(unsigned int arg1,uint64_t arg2)
{
  ...
  if (3 < arg1) {
    ...
    sk_panic_msg(0,(uint64_t)(void *)sk_str_105);
  }
  t1 = sk_tpidrro;
...
void sk_syscall_set_handlers2(unsigned int arg1,uint64_t arg2)
{
  ...
  if (3 < arg1) {
    ...
    sk_panic_msg(0,(uint64_t)(void *)sk_str_103);
  }
  t1 = sk_tpidrro;
  t0 = t1 + (unsigned long)arg1 * 8;
...
void sk_syscall_cap_dispatch(unsigned long *arg1,uint64_t arg2,unsigned long arg3,long arg4,int arg5)
{
  ...
  *t13 = t24 + 1;
  if (t24 < 0x400) {
    ...
    stk1 = sk_vspace_get_ops();
    t2 = (**(sk_code_t *)(stk1.hi + 0x30))(stk1.lo,t19,&stk5,&stk7,0,0);
    t20 = sk_cnode_scan2();
    if (((t20 & 1) == 0) &&
    ...
    if (t2 == '\0') {
      ...
      *(long *)(t20 + 0x170) = t6;
      ...
      if (t6 == 0) {
        ...
        stk1 = sk_vspace_get_ops();
        t2 = (**(sk_code_t *)(stk1.hi + 0x40))(stk1.lo,t21,1,t6);
        if (t2 == '\0') {
          t7 = sk_vspace_op2();
          *(long *)(t20 + 0x70) = t7;
          if (t7 == 0) {
                      ...
                      *t11 = t6;
                      ...
                      if (*(long *)(t8 + 0x208) == -1) {
                        ...
                        if ((*(long *)(t20 + 0x130) - t22) + *(long *)(t20 + 0x138) <
                          ...
                          t12[0x2f] = 0;
                          t12[0x2e] = 0;
                          t12[0x35] = ((uint8_t *)stk1[5]stk1)[5];
                          t12[0x30] = ((uint8_t *)stk1[0]stk1)[0];
                          t12[0x31] = ((uint8_t *)stk1[1]stk1)[1];
                          t12[0x33] = ((uint8_t *)stk1[3]stk1)[3];
                          t12[0x32] = ((uint8_t *)stk1[2]stk1)[2];
                          t12[0x34] = ((uint8_t *)stk1[4]stk1)[4];
                          t12[0x37] = ((uint8_t *)stk1[7]stk1)[7];
                          t12[0x36] = ((uint8_t *)stk1[6]stk1)[6];
...
void sk_restore_ctx(long arg1)
{
  ...
  if (t8 <= t8 + 0x178) {
    ...
    *(uint8_t *)(t8 + 0x80) = 1;
    ...
    sk_panic_msg(0,(uint64_t)(void *)sk_str_108);
  }
...
void sk_restore_ctx1(uint64_t arg1)
{
  ...
  if (t7 <= t7 + 0x178) {
    ...
    *(uint8_t *)(t7 + 0x80) = 1;
    ...
    sk_lock_dispatch_18();
    if (t0 == 2) {
      sk_waitq_dequeue((unsigned long *)t7);
      t1 = sk_kernel_get();
      t4 = (unsigned short *)(t1 + 0x38);
      t5 = *t4;
      *t4 = t5 - 1;
...
void sk_save_ctx(uint64_t arg1,uint64_t arg2,long arg3)
{
  ...
  if (arg3 == 0) {
    ...
    t0 = sk_error_classify(2,(uint8_t (*)[16])arg3,(uint8_t (*)[16])0,1);
  }
  t1 = sk_error_classify(2,(uint8_t (*)[16])arg2,(uint8_t (*)[16])0,0);
...
void sk_save_ctx2(uint64_t arg1,uint64_t *arg2,uint64_t arg3)
{
  ...
  sk_cap_record(2,t0,(uint8_t (*)[16])&stk0,0);
  stk0 = sk_macho_segcmd(stk0.lo,stk0.hi,*arg2,arg2[1]);
...
void sk_restore_ctx3(long arg1)
{
  ...
  sk_panic_msg(0,(uint64_t)(void *)sk_str_90);
}
...
void sk_alloc_frame(uint64_t *arg1,unsigned long arg2,unsigned int arg3)
{
  ...
  if (arg2 < 0xffffffffffffc000) {
    ...
    if ((t5 & t5 - 1) == 0) {
      ...
      lStack_68 = 0;
      stk0 = sk_vspace_get_ops();
      t4 = (**(sk_code_t *)(stk0.hi + 0x30))
                        (stk0.lo,(arg3 & 4) << 0xb | (arg3 >> 3 & 1) << 9 | t5,
                         stk5,&stk6,0,stk5);
      t4 = t4 & 0xff;
      if (t4 == 0) {
        stk7 = arg2;
