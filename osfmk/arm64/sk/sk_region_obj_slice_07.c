...
/* Forward declarations (unspecified-arg K&R form: any call count accepted;
 * definitions below carry the real prototypes). */
void sk_swift_vcall();
void sk_swift_tailcall_a();
void sk_swift_tailcall_b();
void sk_swift_peek_byte();
bool sk_swift_utf8_category();
void sk_swift_string_index_back();
void sk_swift_string_index_back_ascii();
long sk_swift_utf8_decode_scalar();
void sk_swift_throw();
long sk_swift_string_char_width();
void sk_swift_throw_b();
void sk_swift_throw_c();
bool sk_swift_is_join_control();
void sk_swift_string_lowercased();
unsigned int sk_swift_utf8buf_push_scalar();
void sk_swift_utf8_decode_forward();
void sk_swift_string_uppercased();
void sk_swift_count_leading_graphemes();
void sk_swift_count_leading();
unsigned int sk_swift_utf8buf_pop();
void sk_swift_utf8buf_pop_store();
unsigned int sk_swift_utf8buf_pop_validate();
void sk_swift_string_slice_ascii();
void sk_swift_string_slice();
long sk_swift_bytes_to_index();
void sk_swift_bytes_to_index_store();
void sk_swift_validutf8_fatal();
unsigned int sk_swift_utf8buf_shift();
void sk_swift_validutf8_fatal_b();
void sk_swift_utf8buf_shift_store();
void sk_swift_utf8buf_shift_fatal();
bool sk_swift_bitset_contains();
void sk_swift_index_from_bytes();
void sk_swift_utf8_slice_store();
long sk_swift_index_distance();
void sk_swift_utf8buf_push();
int sk_swift_utf8buf_pop_scalar();
void sk_swift_string_index_bounds();
void sk_swift_scalar_from_byte();
void sk_swift_utf8buf_push_byte();
void sk_swift_char_from_utf8();
void sk_swift_byte_peek();
void sk_swift_utf8buf_pop_byte();
void sk_swift_char_width_a();
void sk_swift_char_width_b();
void sk_swift_utf8buf_push4();
void sk_object_dispatch();
void sk_object_alloc_pages_glue();
void sk_swift_array_store();
void sk_object_vcall();
void sk_object_alloc_call();
void sk_swift_array_store4();
void sk_swift_array_init();
void sk_swift_array_move();
void sk_swift_range_init();
void sk_object_method_loop_a();
void sk_object_method_loop_b();
void sk_object_method_loop_c();
void sk_object_method_loop_d();
void sk_object_dispatch_a();
void sk_object_count_get();
void sk_object_service_loop();
sk_pair_t sk_swift_pointer_adopt();
void sk_swift_pointer_adopt_store();
void sk_swift_unsafe_mutrawptr_nil();
void sk_swift_unsafe_ptr_nil();
void sk_swift_unsafe_mutptr_nil();
void sk_object_method_loop_e();
void sk_swift_alloc_checked();
void sk_swift_alloc_checked_size();
void sk_swift_memcmp_range();
void sk_swift_wrap_1d80e0_a();
void sk_swift_wrap_1d80e0_b();
void sk_swift_dictionary_init();
void sk_swift_string_transform();
unsigned long sk_object_read_slot();
void sk_object_call_slot();
sk_pair_t sk_object_read_pair();
bool sk_object_compare();
void sk_object_dispatch_b();
sk_pair_t sk_swift_sort_partition();
void sk_swift_sort_merge();
void sk_object_method_loop_f();
void sk_swift_sort_entry();
void sk_object_read_slot2();
long sk_swift_checked_add();
void sk_swift_checked_sub();
void sk_swift_checked_add_store();
void * sk_swift_array_builder();
sk_pair_t sk_swift_array_builder_init();
void sk_swift_array_builder_snapshot();
void sk_object_method_loop_g();
void sk_swift_spin_check();
void sk_object_method_loop_h();
void sk_swift_hash();
void sk_swift_hash_update();
void sk_swift_hash_b();
void sk_swift_hash_wrap();
void sk_swift_hash_set();
void sk_swift_sequence_zip();
void sk_swift_sequence_zip_b();
void sk_object_method_loop_i();
unsigned long sk_swift_buf_capacity_clamp();
sk_pair_t sk_swift_collection_label();
void sk_swift_label_wrap_a();
void sk_swift_label_wrap_b();
void sk_swift_label_wrap_c();
void sk_object_describe();
void sk_object_debug_desc();
unsigned int sk_swift_elem_count_check();
sk_pair_t sk_swift_optional_label();
void sk_swift_debug_wrap_a();
void sk_swift_debug_wrap_b();
void sk_swift_describe_wrap_a();
void sk_swift_describe_wrap_b();
void sk_swift_elem_wrap_a();
void sk_swift_elem_wrap_b();
void sk_swift_elem_wrap_c();
sk_pair_t sk_swift_collection_description();
void sk_object_error();
void sk_swift_error_wrap_a();
void sk_swift_error_wrap_b();
void sk_swift_error_wrap_c();
void sk_object_dispatch_c();
unsigned long sk_swift_count_zero();
unsigned long sk_swift_count_one();
void sk_object_call_c();
void * sk_swift_collectionofone_peek();
void * sk_swift_collectionofone_peek_b();
void sk_swift_collectionofone_call();
void sk_swift_collectionofone_call_b();
void sk_swift_copy_into();
void sk_swift_range_equal();
void sk_object_release_wrap();
void sk_swift_collectionofone_trap();
void * sk_swift_collectionofone_make();
void sk_swift_collectionofone_dtor();
sk_pair_t sk_swift_emptycollection_make();
void sk_object_release_wrap2();
void sk_swift_append();
void sk_swift_count_one_pop_a();
void sk_swift_count_one_pop_b();
void sk_swift_insert_a();
void sk_swift_insert_b();
void sk_swift_insert_c();
void * sk_swift_collection_make();
void sk_swift_append_b();
void sk_swift_count_zero_pop_a();
void sk_swift_count_zero_pop_b();
void sk_swift_append_c();
void sk_swift_append_d();
void sk_swift_pointer_unwrap();
void sk_swift_string_build();
void sk_swift_string_build_store();
void sk_swift_sequence_concat();
void sk_swift_wrap_2c55b4_a();
void sk_swift_wrap_2c55b4_b();
...
void *sk_swift_array_builder(long *out, unsigned long *src, long p3)
{
    ...
    *out = p;
    unsigned long u = sk_swift_array_builder_init(p, *src, sk_swift_fixedbuf[0], sk_swift_fixedbuf[1],
...
void *sk_swift_collection_make(long *out, unsigned long *src)
{
    ...
    *out = p;
    unsigned long u = (unsigned long)sk_swift_collectionofone_peek(p, *src).lo;
    *(unsigned long *)(p + 0x20) = u;
    return (void *)sk_td_003471a4;
}
...
void sk_swift_sequence_concat(unsigned long p1, unsigned long p2, long p3, long p4)
{
    ...
    while (1) {
        if (j < n1) {
            sk_h_003510dc(0);
            sk_h_0019ea20();
            long a = (long)sk_object_read_slot().lo;
            sk_h_00351648();
            sk_h_00354d14(0);
            sk_h_0019ea20();
            long b = (long)sk_object_read_slot().lo;
            sk_h_00351648();
            sk_h_0035242c();
            sk_h_0019ea20(0, 0);
            sk_h_00352dd0();
