 ...
 *
 * The mach-trap argument-munger trap_arg_munger (est. trap_arg_munger,
 ...
 * from hv_vmm_present (est. hv_vmm_present), which invokes the record's
 ...
 *   boot_prop_getter @ 0xfffffe000bf77834  (est. boot_prop_getter)
 */
 ...
 * PTR_hv_op_table (19 entries, see docs/chain-map.md). All take the
...
kern_return_t hv_trap_op_10(uint64_t mask);        /* idx10 FUN_fffffe000b98e488 (unidentified) */
...
kern_return_t hv_trap_op_15(uint64_t mode);           /* idx15 FUN_fffffe000b98e788 (unidentified) */
